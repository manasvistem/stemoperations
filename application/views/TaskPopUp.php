<div class="mt-4">
    ...
    <div class="modal fade" id="modalCenterProgramTimeLine" tabindex="-1" style="display: none;" aria-hidden="true">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <!-- Modal -->
        <div class="modal fade" id="PMVisitmodalCenter" tabindex="-1" style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="PMVisitmodalCenterTitle">Modal title</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <hr>
          <div class="modal-body">

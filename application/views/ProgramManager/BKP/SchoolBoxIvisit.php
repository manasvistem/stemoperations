             ...
             <div class="row">
                ...
                ?>
                  ...
                  <div class="row p-3 text-center">
                      <?php $fsch = $this->Menu_model->get_SchoolIvisit($pcode); foreach($fsch as $sch){  $sid=$sch->sid;$task = $this->Menu_model->get_spdinstallvisit($sid);$cdate=date('Y-m-d H:i:s');?>
                      
                          <div class="col-sm-12 col-md-4 col-lg-4 mb-4">
                              <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100">
                                   <a href="<?=base_url();?>Menu/CallDetail/<?=$sid?>/<?=$task[0]->tid?>">

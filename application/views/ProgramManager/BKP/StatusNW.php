  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Last Task Befour 15 Days</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="card">
        ...
        <div>
                  <form class="p-3" method="POST" action="<?=base_url();?>Menu/StatusNW">
                      <select name="status">
                          <option>All</option>
                    ...
                    <div class="col-12">
                            ...
                            $piid = $_POST["piid"]; ?>
                                <div class="card p-3">
                                    ...
                                    <?php $spd = $this->Menu_model->get_StatusNW($status,$action,$piid);
                                    foreach($spd as $spd){
                                        $lasttdate = $spd->abc;
                                        $currentDate = new DateTime();
                                        $currentDate->modify('-15 days');
                                        $currentDate->format('Y-m-d');
                                        if($lasttdate<$currentDate){
                                    
                                    ?>
                                        <div  class="card p-3 col-2 border border-danger">
                                            Project Code<br><b><?=$spd->project_code?></b><hr>
                                            School Name<br><b><?=$spd->sname?></b><hr>
                                            PIA Name<br><b><?=$spd->uname?></b><hr>
                                            Last Task Date<br><b><?=$spd->abc?></b><hr>
                                        </div>
                                    <?php }} ?>
                                </div>
                            <?php } ?>

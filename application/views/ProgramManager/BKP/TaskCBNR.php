  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Task compelete but not review</h1>
          </div>
          <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card col-12 p-4 text-center">
                <?php foreach($mdata as $md){$piid=$md->piid;?>
                  ...
                  <div class="row">
                      <?php $aai=1; $cdatet = date('Y-m-d H:i:s'); $data = $this->Menu_model->get_TaskCBNR1($piid); foreach($data as $dt){$ltid=$dt->ltid;?>

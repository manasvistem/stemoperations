       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <form action="<?=base_url();?>Menu/pmrequest" method="post">
                  <div class="form-group">
                    <label>Date and Time</label>
                    <input type="hidden" name="tcname" value="<?=$user['fullname']?>">
                    <input type="datetime-local" class="form-control" name="tdate" id="task_date" min="2022-01-01 00:00:00">
                  </div>
                  <div class="form-group">
                    <label>Task Type</label>
                    <select class="custom-select rounded-0" name="tasttype" id="task_type" >
                        <option>Select Request</option>
                        <option>School Identification</option>
                  </select>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="noofschool">
                  </div>

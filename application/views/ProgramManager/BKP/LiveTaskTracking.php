                 ...
                 <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card p-3 text-center border border-danger">
                            ...
                            <div class="row">
                                <?php $aai=1;
                                $livetask = $this->Menu_model->get_livetask($tdate);
                                ...
                                <div  class="card p-3 col-3 border border-success">
                                    ...
                                    <b><?=$ltask->sname?></b><hr>
                                    <b><?=$ltask->uname?></b><hr>
                                    <b><?=$page=$ltask->checklist?></b><hr>
                                    <b><?=$tid=$ltask->tid?></b><hr>
                                    <b><?=$sid=$ltask->sid?></b><hr>
                                ...
                                <div  class="card p-3 col-9 border border-success">
                                    <div  class="row">
                                <?php
                                           ...
                                           <?php if($vu){if($vu[0]->ans2!=''){?><a href="#" class="pop2"><iframe class="embed-responsive-item" src="<?=$url2?>" class="img-thumbnail"></iframe></a><?php }}?>
                                           
                                           <?php if($color=="bg-danger"){?>
                                           <hr><button class="btn btn-default" id="Reminder<?=$aai?>" value="<?=$tid?>">Reminder</button>
                                           <?php } ?>
                                           <?php if($color=="bg-success"){?>
                                           <hr><button class="btn btn-default" id="Appreciate<?=$aai?>" value="<?=$tid?>">Appreciate</button>
                                           <?php } ?>
                                           </div>
                                    <?php $aai++;} ?>
                                    </div>

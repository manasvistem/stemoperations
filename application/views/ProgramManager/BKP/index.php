          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-light text-secondary"> 
              <div class="inner">
                ...
                <?php foreach($pmspd as $st){?>
                <p>Installed Pending - <b><?=$st->ab;?></b></a><hr>
                 <p><a href="pmschool/<?=$uid?>/0">Total School - <b><?=$st->a;?></b></p></a><hr>
                 <p><a href="pmschool/<?=$uid?>/1">New School - <b><?=$st->b;?></b></p></a><hr>
                 <p><a href="pmschool/<?=$uid?>/2">FTTP Done - <b><?=$st->c;?></b></p></a><hr>
                 <p><a href="pmschool/<?=$uid?>/3">Utilization Initiated School - <b><?=$st->d;?></b></p></a><hr>
                 <p><a href="pmschool/<?=$uid?>/7">Inactive School - <b><?=$st->h;?></b></p></a><hr>
                 <p><a href="pmschool/<?=$uid?>/4">Average School - <b><?=$st->e;?></b></p></a><hr>
                 <p><a href="pmschool/<?=$uid?>/5">Good School - <b><?=$st->f;?></b></a>
                 ...
                 <p><a href="pmschool/<?=$uid?>/6">Model School - <b><?=$st->g;?></b></p></a><hr>
                 <p><a href="pmschool/<?=$uid?>/8">Client Readiness School - <b><?=$st->i;?></b></p></a><hr>
                <?php } ?>
              </div></div>
              <div class="icon">
                <i class="ion ion-person-add"></i>
              ...
              <div class="card-body">
                  <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
                        <ul id="myUL">
                          ...
                          <?php }else{ 
                          $pending=$this->Menu_model->get_provisiont($lstttid);

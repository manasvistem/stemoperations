...
<html lang="en">
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <?php if($d->assignstatus=='0'){?>
                                          <!-- <button type="button" id="assign_to<?=$i?>" value="<?=$tid?>">Click</button> -->
                                          <a class="btn btn-primary p-1" href="<?=base_url()?>Menu/TheAssigningProcess/<?=$rtype?>/<?=$tid?>">Assign</a> 
                                          <?php }else{
                                            if($d->status=='1'){ echo 'Request Closed'; }
                                            else{
                                                $rid = $d->id;
                ...
                <div class="modal-body">
                  <div class="card card-form col-md-12">
                    ...
                    <div class="col-lg-12 card-body">
                      ...
                      <textarea rows="10" name="rcomment" class="form-control"></textarea>
                      <hr>
                      <button type="submit" class="btn btn-primary mt-3" onclick="this.form.submit(); this.disabled = true;">Submit</button>
                      </form>
                    </div>
    ...
    "columnDefs": [
        { "width": "auto", "targets": "_all" } // Allow all columns to adjust width
    ]

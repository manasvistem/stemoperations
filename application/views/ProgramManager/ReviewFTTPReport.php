...
<div class="container mt-5 mb-5 p-4 border rounded shadow-sm bg-light">
    ...
    <!-- FTTP Section -->
     <form name="fttpreporttask" action="updateFTTPReportZTaskView" method="post" >
    <div class="mb-4">
    ...
    <div class="mb-4">
        ...
        <textarea name="final_remark" class="form-control" rows="4" placeholder="Enter your remarks..."></textarea>
    </div>

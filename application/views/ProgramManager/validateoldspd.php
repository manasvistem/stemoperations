...
<div class="container-fluid p-3">
    <form action="<?=base_url();?>Menu/validateOldSPD" method="POST" target="_blank">
    <select class="ml-2" name="user_id" id="user_id">
        <option>All</option>
        <?php $du=$this->Menu_model->get_user(); foreach($du as $d){ ?>
        <option value="<?=$d->id?>"><?=$d->fullname?></option>
        <?php } ?>
    </select>
    <select class="ml-2" name="pcode" id="pcode">
        <option>All</option>
    </select>
                        ...
                        <div class="table-responsive">
                            <div class="table-responsive">     
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      <?php $i=1; foreach($spd as $d){ if($d->zh_apr==1){ if($d->pm_apr==0){
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$pi[0]->fullname?></td>
                                        <td><?=$zh[0]->fullname?></td>
                                        <td><a href="apprReject/<?=$d->id?>"><button type="button" class="btn btn-success">Click</button></a>

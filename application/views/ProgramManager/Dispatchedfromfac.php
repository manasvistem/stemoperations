             ...
             <div class="row">
                ...
                ?>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm p-3 rounded border border-info p-3">
                        <center><h4>Dispatch Detail</h4></center>
                  </div>
                  <div class="row p-3 text-center">
                      <?php $fdisp = $this->Menu_model->get_Dispatchdetail($pcode); foreach($fdisp as $disp){ ?>
                          <div class="col-sm-12 col-md-4 col-lg-4 mb-4">
                              <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100">
                                <b><?=$disp->boxtype?></b><hr>
                                <b><?=$disp->dispatchdt?></b><hr>
                                <b><?=$disp->weighkg?> KG</b><hr>
                                <b><?=$disp->weighdt?></b><hr>
                                <img src="https://stemfactory.in/<?=$disp->weighvideo?>"  width="90%"><hr>

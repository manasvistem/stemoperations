             ...
             <div class="row">
                ...
                ?>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm p-3 rounded border border-info p-3">
                        <center><h4>Ewaybill Info</h4></center>
                  </div>
                  <div class="row p-3 text-center">
                      <?php $feway = $this->Menu_model->get_ewaybillinfo($pcode); foreach($feway as $eway){ ?>
                          <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                              <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100">
                                <b><?=$eway->project_code?></b><hr>
                                <b><?=$eway->uploaddate?></b><hr>
                                <div style="display: inline-block; vertical-align: top; margin-right: 20px;">
                                  <center><object data="https://stemfactory.in/<?=$eway->ewaybill?>" type="application/pdf" width="150%" height="145">
                                    <p>Your browser does not support PDF embedding. You can download the PDF <a href="https://stemfactory.in/<?=$eway->ewaybill?>">here</a>.</p>
                                  </object></center>
                                  </div>
                                
                                <b><?=$eway->ewaybill2?></b><hr>
                                </div>
                          </div>
                      <?php } ?>
                  </div>                  

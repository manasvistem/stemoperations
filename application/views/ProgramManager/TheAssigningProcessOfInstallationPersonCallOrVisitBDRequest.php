            ...
            <table class="table table-sm">
              <tbody>
                ...
                <tr class="table-primary">
                  <td>School Name</td>
                  <td><?php 
                    $schoolnameData = $this->Menu_model->get_school_detailbyid($bdr[0]->sid);
                    $schoolname = $schoolnameData[0]->sname;
                    echo $schoolname;
          ...
          <div class="card">
            ...
            <div class="card p-3" style="background:#dcf3ffed">
              ...
              <div class="mb-4" id="inauguration_Card">
                ...
                <hr>
                <?=form_open('Menu/BDRequestAssignToProcessInstallationPersonCallorVisit')?>
                <div class="row">
                  <div class="col-md-12">
                      ...
                      <div class="mb-1 p-2">
                        ...
                        <select id="AssignTo_<?=$k;?>" name="assignto[]" class="form-control" required >
                          ...
                          <?php $pia=$this->Menu_model->get_user();
                            foreach($pia as $pia){if($pia->dep_id==4){
                                if($schoolnameData[0]->ins_id == $pia->id){
                                    $selected  = 'selected';
                                }else{
                                    $selected = '';
                                }
                                ?>
                          <option <?=$selected;?> value="<?=$pia->id?>"><?=$pia->fullname?></option>
                          <?php }} ?>
                        </select>
                      </div>
                    </div>

  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">School Link to Project Code</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group" id="schooldata"> </div>
                    
                  <div class="form-group">
                    <label for="sname">School Name</label>
                    <input type="text" class="form-control" name="sname" id="sname" placeholder="School Name">
                  </div>
                  <div class="form-group">
                    <label for="saddress">Address</label>
                    <input type="text" class="form-control" name="saddress" id="saddress" placeholder="Location">
                  </div>
                  <div class="form-group">
...
$('#project_code').on('change', function b() {
    var project_code = document.getElementById("project_code").value;
   
$.ajax({
url:'<?=base_url();?>Menu/getspdbypc',
type: "POST",
data: {

...
<div class="wrapper">
  ...
  <form class="p-3" method="POST" action="<?=base_url();?>Menu/ReportVisitPIA">
  <input type="date" name="date" class="mr-2">
  <select name="pia" class="mr-2">
      <option value='1'>All</option>
      <?php $pia=$this->Menu_model->get_user_pia();foreach($pia as $pi){?>
      <option value='<?=$pi->piid?>'><?=$pi->fullname?></option>
      <?php } ?>
  </select>
  ...
  <button type="submit" class="bg-primary text-light">Filter</button>
    ...
    <?php if(isset($_POST["date"])){$date = $_POST["date"]; $pia = $_POST["pia"];?>
    <section class="content">
     <div class="container-fluid">
        <div class="col-sm col-md-12 col-lg-12 m-auto">
            <div class="card card-primary card-outline p-3">
                <center><h4>Task Report Summary of PIAs</h4></center><hr>
                <?php date_default_timezone_set("Asia/Kolkata");
                    $aai=1; $date = date('Y-m-d', strtotime('+0 day'));
                    $vtask1=$this->Menu_model->get_livevisitpia1($pia,$date);?>
                    ...
                    <div class="row">
                    <?php $vtask2=$this->Menu_model->get_livevisitpia2($pia,$date);
     ...
     <div class="col-sm col-md-12 col-lg-12 m-auto">
         <div class="card card-primary card-outline">
              <div class="card-body box-profile row">
                                        ...
                                        $nxtdtask=$this->Menu_model->get_reportvisitpia($pia,$date);

          ...
          <div class="card">
            <table class="table table-sm">
              <tbody>
                ...
                <tr class="table-primary">
                  <td>Meetings Links</td>
                  <td>
                  <?php 
                    $pattern = '/(https?:\/\/[^\s]+)/';
                    $result_stirings = preg_replace($pattern, '<a href="$1" target="_blank">$1</a>', $bdr[0]->meetings_links);
          ...
          <div class="card">
            ...
            <div class="card p-3" style="background:#dcf3ffed">
              ...
              <div class="mb-4" id="inauguration_Card">
                ...
                <hr>
                <?=form_open('Menu/BDRequestAssignToProcessOnlineDemo')?>
                <div class="row">
                  <div class="col-md-12">

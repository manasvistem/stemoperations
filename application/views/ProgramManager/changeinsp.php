       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <form action="<?=base_url();?>Menu/changespdinsp" method="post">
                    ...
                    <select name="spdi" class="custom-select rounded-0" id="spd" class="m-2">
                    </select>
                    
                    <div class="alert alert-success" id="spdinfo">
                      
                    </div>
                  
                  
                  <div class="form-group">
                    <label>Change Installation Person</label>

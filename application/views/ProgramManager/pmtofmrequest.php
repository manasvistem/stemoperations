       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <form action="<?=base_url();?>Menu/sendtofm" method="post">
                    <div class="form-group">
                        <label>Select Program</label>
                        <input list="pcodet" class="form-control" name="program">
                  ...
                  <div class="form-group">
                    <label>Request</label>
                    <textarea class="form-control" name="request" placeholder="Request" ></textarea>
                  </select>
                  </div>
                  <div class="form-group">

  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>users plan/not plan</h5></center><hr>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <canvas id="myChart" width="400" height="200"></canvas>
<script>
<?php 
$tdate =date('Y-m-d');
$ddata= $this->Menu_model->get_tpnpgraph($uid, $tdate);?>
        // Data for the chart
        var data = {
            labels: ['taskPlanUserCount (<?=$ddata[0]->taskPlanUserCount?>) ', 'nonPlanningUsersCount (<?=$ddata[0]->nonPlanningUsersCount?>)'],
            datasets: [{
                data: [<?=$ddata[0]->taskPlanUserCount?>, <?=$ddata[0]->nonPlanningUsersCount?>], // Replace with your actual values

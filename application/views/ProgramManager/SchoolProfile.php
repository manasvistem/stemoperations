              ...
              <div class="card-body box-profile">
                  <div class="d-flex flex-column align-items-center text-center">
                    <div class="mt-3">
                      ...
                      <a href="<?=base_url();?>Menu/ProgramProfile/"><h4><?=$spd[0]->clientname?></h4>
                      <p class="text-secondary mb-1"><?=$pcode=$spd[0]->project_code?></p></a>
           ...
           <div class="row">   
             <div class="col-sm col-md-12 col-lg-12">
                ...
                <div class="row">            
                  ...
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <b>15 Communication</b><hr>
                     Targer Count<br><b>15</b><hr>
                     <b><?php $date = $ptimeline[0]->communication; $date = new DateTime($date); echo $st = $date->format('Y-m-d');?></b><hr>
                     <b><?=$this->Menu_model->timediff($st,$cdate)?></b>
                  </div>
                  
                  <?php $tdata = $this->Menu_model->get_sdtaskwise($sid,'page52','Call'); $cont = $tdata[0]->cont;?>
                  <?php $date = $ptimeline[0]->callsfu; $date = new DateTime($date); $st = $date->format('Y-m-d');?>
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <a href="<?=base_url();?>Menu/SWTaskList/<?=$sid?>/page52/Call"><b>Calls for Activation</b><hr>
                     Targer Count<br><b>10</b><hr>
                  ...
                  <?php $tdata = $this->Menu_model->get_sdtaskwise($sid,'page31','Visit'); $cont = $tdata[0]->cont;?>
                  <?php $date = $ptimeline[0]->rttp; $date = new DateTime($date); $st = $date->format('Y-m-d');?>
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <b>RTTP</b><hr>
                     Targer Count<br><b>1</b><hr>
                     Achieved Count<br><b><?=$cont?></b><hr>
                  ...
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <b>Report</b><hr>
                     Targer Count<br><b><?$ptimeline[0]->reporttype?></b><hr>
                     <b><?php $date = $ptimeline[0]->wmessage; $date = new DateTime($date); echo $st = $date->format('Y-m-d');?></b><hr>
                     <b><?=$this->Menu_model->timediff($st,$cdate)?></b>
                  </div>
                  
                  <?php $tdata = $this->Menu_model->get_sdtaskwise($sid,'page28','Visit'); $cont = $tdata[0]->cont;?>
                  <?php $date = $ptimeline[0]->diy; $date = new DateTime($date); $st = $date->format('Y-m-d');?>
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <b>DIY</b><hr>
                     Targer Count<br><b>1</b><hr>
                     Achieved Count<br><b><?=$cont?></b><hr>
                  ...
                  <?php $tdata = $this->Menu_model->get_sdtaskwise($sid,'','Utilisation'); $cont = $tdata[0]->cont;?>
                  <?php $date = $ptimeline[0]->utilisation; $date = new DateTime($date); $st = $date->format('Y-m-d');?>
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <b>Utilisation</b><hr>
                     Targer Count<br><b>10</b><hr>
                     Achieved Count<br><b><?=$cont?></b><hr>
                  ...
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <b>Maintenance</b><hr>
                     Targer Count<br><b>1</b><hr>
                     <b><?php $date = $ptimeline[0]->maintenance; $date = new DateTime($date); echo $st = $date->format('Y-m-d');?></b><hr>
                     <b><?=$this->Menu_model->timediff($st,$cdate)?></b>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <b>Base Line M&E</b><hr>
                     Targer Count<br><b>1</b><hr>
                     <b><?php $date = $ptimeline[0]->blmne; $date = new DateTime($date); echo $st = $date->format('Y-m-d');?></b><hr>
                     <b><?=$this->Menu_model->timediff($st,$cdate)?></b>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <b>End Line M&E</b><hr>
                     Targer Count<br><b>1</b><hr>
                     <b><?php $date = $ptimeline[0]->elmne; $date = new DateTime($date); echo $st = $date->format('Y-m-d');?></b><hr>
                     <b><?=$this->Menu_model->timediff($st,$cdate)?></b>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <b>CaseStudy</b><hr>
                     Targer Count<br><b>1</b><hr>
                     <b><?php $date = $ptimeline[0]->casestudy; $date = new DateTime($date); echo $st = $date->format('Y-m-d');?></b><hr>
                     <b><?=$this->Menu_model->timediff($st,$cdate)?></b>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <b>NSP</b><hr>
                     Targer Count<br><b>1</b><hr>
                     <b><?php $date = $ptimeline[0]->nsp; $date = new DateTime($date); echo $st = $date->format('Y-m-d');?></b><hr>
                     <b><?=$this->Menu_model->timediff($st,$cdate)?></b>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm p-3 bg-danger rounded border">
                     <b>PM Visit</b><hr>

  ...
  <div class="content-wrapper">
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="text-center m-3 text-secondary">Team Detail</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                            ...
                            <div class="table-responsive">     
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                         ...
                                         <td><?=$dt->phoneno?></td>
                                         <td><?=$dt->status?></td>
                                         <td><button id="manage<?=$i?>" value="<?=$dt->id?>" style="background: none;color: inherit;border: none;padding: 0;font: inherit;cursor: pointer;outline: inherit;"><i class="fa fa-cog" aria-hidden="true"></i></button></td>
                                     </tr>
                                     <?php $i++;} ?>
                                  </tbody>
                                </table>

          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="<?=base_url() ?>Menu/DayManagement"
                ...
                class="menu-link">
                <i class="menu-icon tf-icons bx bx-support"></i>
                <div class="text-truncate" data-i18n="MyDayDetail">School Review By PIA</div>
              </a>
            </li>
            <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="<?=base_url() ?>Menu/editProfile"
                ...
                class="menu-link">
                <i class="menu-icon tf-icons bx bx-support"></i>
                <div class="text-truncate" data-i18n="MyDayDetail">Edit Profile</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?=base_url() ?>Menu/logout"
                ...
                class="menu-link">
                <i class="menu-icon tf-icons bx bx-support"></i>
                <div class="text-truncate" data-i18n="MyDayDetail">Logout</div>
              </a>
            </li>
          </ul>
        </aside>

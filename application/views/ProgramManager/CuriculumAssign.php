       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <form action="<?=base_url();?>Menu/assigncuriculum" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" name="tdate" value="<?=date('Y-m-d H:i:s')?>">
                      </div>
                      <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <div class="table-responsive">                            
                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      <?php $i=1;
                                      $mdata = $this->Menu_model->get_curiculum();
                                      foreach($mdata as $d){
                                      ?>

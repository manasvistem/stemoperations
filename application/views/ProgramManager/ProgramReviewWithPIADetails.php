...
<html lang="en">
  <head>
    ...
    <title>PIA Review Details with Program | STEM LEARNING PVT LTD </title>
                          ...
                          <table id="example1" class="table table-striped">
                            <thead class="thead-dark">
                              <tr>
                                ...
                                <th scope="col">Total No of School</th>
                                <th scope="col">Complete School</th>
                                <th scope="col">Pending School</th>
                            ...
                            <tbody>
                              <?php 
                                $l=1;
                                foreach($getCompPcode as $comreve){
                                  ?>
                              <tr>
                                <td><?= $l ?></td>
                                <td>
                                  <a target="_BALNK" href="<?=base_url();?>Menu/ProjectWiseReviewDetails?pcode=<?= $comreve->projectcode ?>">
                                  <?= $comreve->projectcode?>
                                  </a>
                                </td>
                                <td>
                                    <?php 
                                    $spds = $this->Menu_model->get_spdbypc($comreve->projectcode);
                                    echo sizeof($spds);
                                    ?>
                                </td>
                                <td>
                                <?php 
                                    $spdscomp = $this->Menu_model->getCompleteSchoolReview($comreve->projectcode);
                                    echo sizeof($spdscomp);
                                    ?>
                                </td>
                                <td>
                                    <?php 
                                   $sizeofpen =  sizeof($spds) - sizeof($spdscomp);
                                   echo $sizeofpen;
                                    ?>
                                </td>
                                <td>
                                    ...
                                    $sizeofpen =  sizeof($spds) - sizeof($spdscomp);
                                    if($sizeofpen == 0){
                                        echo "<span class='p-2 bg-success'>Complete</span>";
                                    }else{

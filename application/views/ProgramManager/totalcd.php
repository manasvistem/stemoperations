                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                          ...
                                          <th>Total Outbond</th>
                                          <th>Installtion Done on App</th>
                                          <th>Installtion Report</th>
                                          <th>FTTP on App</th>
                                          <th>FTTP  Report</th>
                                          <th>Maintenance  on App</th>
                                    ...
                                    <tbody>
                                      ...
                                      foreach($pc as $pc){
                                        ...
                                        $projd = $this->Menu_model->get_projectdetail($spdpc);
                                        $plsc = $this->Menu_model->get_projlsc($spdpc);
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="ProgramPage/<?=$pc->id?>"><?=$pc->projectcode?></a></td>
                                        <td><?=$pc->project_year?></td>
                                        <td><?=$plsc[0]->language?></td>
                                        <td><?=$plsc[0]->state?></td>
                                        <td><?=$plsc[0]->city?></td>
                                        <td><?=$pc->noofschool?></td>
                                        <td><a href="client_school/<?=$pc->id?>"><?=sizeof($tspd)?></a></td>
                                        <td><?=$projd[0]->tcall;?></td>
                                        <td><?=$projd[0]->visit;?></td>
                                        <td><?=$projd[0]->utilisation;?></td>
                                        <td><?=$projd[0]->outbond;?></td>
                                        <td><?=$projd[0]->ins;?></td>
                                        <td><?=$insr?></td>
                                        <td><?=$projd[0]->fttp;?></td>
                                        <td><?=$fttpr?></td>

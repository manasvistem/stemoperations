  ...
  <!-- User details -->
  <div id="add_assign" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-standard-title" aria-hidden="true">
   ...
   <center><h5>Task Assign to</h5></center><hr>
       <?=form_open('Menu/ForwardTask')?>
       <input type="hidden" id="tid" name="tid">
       <input type="hidden" id="fromuser" name="fromuser" value="<?=$user['id']?>">
       <div class="form-group">
        <label for="to_user">Person</label>
        <select class="custom-select rounded-0" name="touser" id="touser">
        <option>Select Person (ZM)</option>
        <?php $du=$this->Menu_model->get_user(); foreach($du as $d){ if($d->dep_id=='11'){?>
   ...
   <button type="submit" class="btn btn-primary mt-3" onclick="this.form.submit(); this.disabled = true;">Submit</button>
                ...
                <!-- User details -->
  <div id="add_ins" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-standard-title" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-standard-title1"></h5>
...
<script type='text/javascript'>
  $(document).ready(function(){
   ...
   $('#assign_log').click(function(){
    $('#add_assign').modal('show');
    var id = document.getElementById("assign_log").value;
  ...
  $('#insassign_log').click(function(){
    $('#add_ins').modal('show');
    var id = document.getElementById("insassign_log").value;

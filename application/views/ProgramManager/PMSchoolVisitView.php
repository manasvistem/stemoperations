...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/PMSchoolVisitSubmit" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3 text-center">
      ...
      if ($main_task_id == 5 || $main_task_id == 6 || $main_task_id == 7 || $main_task_id == 8 || $main_task_id == 9 || $main_task_id == 10 || $main_task_id == 11 || $main_task_id == 12) {
        if ($main_task_id == 5) {
          $uploadBtn_message = "⬆️ Start Journey";
          $takeSalify = "📷 Take Salify";
        } else if ($main_task_id == 6) {
          $uploadBtn_message = "⬆️ Upload Selfie with school";
          $takeSalify = "📷 Take Salify with school";
        } else if ($main_task_id == 7 || $main_task_id == 8 || $main_task_id == 9 || $main_task_id == 10) {
          $uploadBtn_message = "⬆️ Upload First Activity";
          $takeSalify = "📷 Upload First Activity Photo OR Video";
        } else if ($main_task_id == 11) {
          $uploadBtn_message = "⬆️ Upload Final Selfie with school";
          $takeSalify = "📷 Take Final Salify with school";
        } else if ($main_task_id == 12) {
          $uploadBtn_message = "⬆️ Upload More Midea";
          $takeSalify = " Add More Midea";
          $multiple = 'multiple';
          $upload_name = 'start_jaurney[]';
        }
      ...
      <div class="input-group-capture">
        <input type="file" class="form-control d-none" name="<?=$upload_name;?>" id="inputGroupFile02" accept="<?= ($main_task_id == 5 || $main_task_id == 6 || $main_task_id == 11) ? 'image/*' : '' ?>" capture="environment" <?=$multiple;?>>
        <hr>

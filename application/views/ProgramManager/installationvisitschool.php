          ...
          <div class="card col-12  p-3 text-center">
             <div class="row">
                  <?php 
                    ...
                    $spd = $this->Menu_model->get_school_detailbyid($pcode);
                ...
                ?>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm p-3 rounded border border-info p-3">
                        <center><h4>Installation Visit School</h4></center>
                  </div>
                  <div class="row p-3 text-center">
                      <?php $finsv = $this->Menu_model->get_inastallationschoolvisit($pcode); foreach($finsv as $insv){  $sid=$insv->sid;$task = $this->Menu_model->get_spdinstallschoolvisit($sid);$cdate=date('Y-m-d H:i:s');?>
                      
                          <div class="col-sm-12 col-md-4 col-lg-4 mb-4">
                              <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100">
                                   <a href="<?=base_url();?>Menu/LiveReportVisit/<?=$sid?>/<?=$task[0]->tid?>">
                               Client Name<br><b><?=$insv->client_name?></b><hr>
                     Project Code<br><b><?=$insv->projectcode?></b><hr>
                     School Name<br><b><?=$insv->sname?></b><hr>
                     Status<br><b><?=$insv->stname?></b><hr>
                     Address<br><b><?=$insv->saddress?>, <?=$insv->scity?>, <?=$insv->sstate?></b><hr>
                     PIA Involve<br><b><?=$insv->pia?></b><hr>
                     IMP Involve<br><b><?=$insv->imp?></b><hr>
                     Last Update On<br><b><?=$updatedt=$insv->spdudt?></b><hr>

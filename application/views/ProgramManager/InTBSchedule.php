  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Task in the schedule section</h1>
          </div>
          <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card col-12 p-4 text-center">
                <?php $aai=1; foreach($mdata as $md){$piid=$md->piid;?>
                  <div class="col-12 p-3 text-center card card-primary card-outline">
                      <h4><b><?=$md->fullname?></b> has <b><?=$md->task_count?></b> task in the schedule section</h4>
                  </div>
                  <div class="row">
                      <?php $cdatet = date('Y-m-d H:i:s'); $data = $this->Menu_model->get_InTBSchedule1($piid); foreach($data as $dt){$ltid=$dt->ltid;?>
                      <div class="col-lg-3 col-sm p-3 text-center card card-primary card-outline">
                          ...
                          <hr><button class="btn btn-default" id="Reminder<?=$aai?>" value="">Reminder</button>
                      </div>
                      <?php $aai++;} ?>
                  </div>
                  <?php } ?>

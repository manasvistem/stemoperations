    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!--<li class="nav-item">
            <a href="<?=base_url();?>Menu/AddOldClient" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>Menu/Handover" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Handover to PM</p>
            </a>
          </li>
          ...
          <!--<li class="nav-item">
            <a href="<?=base_url();?>Menu/OtherTask" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Other Task</p>
            </a>
          </li>-->
          <li class="nav-item">
            <a href="<?=base_url();?>Menu/CreateRequest" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Create Request</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>Menu/taskTracker" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Task Tracker</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>Menu/search_client" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Client Detail</p>
            </a>
          </li>

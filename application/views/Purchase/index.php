...
<form method="POST" action="Dashboard" class="m-3">
    <input type="date" name="filterdate" value="<?=$tdate?>">
            ...
            <div class="small-box bg-light text-secondary"> 
              <div class="inner">
                ...
                <?php $ttd=$this->Menu_model->get_tdetailbyuser($uid,$tdate);
                      foreach($ttd as $ttd){?>
                    <p><a href="DTDetail/<?=$uid?>/<?=$tdate?>/1">Pending Task to be Schedule - <b><?=$ttd->ab?></b></p></a><hr>
                    <p><a href="DTDetail/<?=$uid?>/<?=$tdate?>/2">Total Task Assign/Planned - <b><?=$ttd->ac?></b></p></a><hr>
                    <p><a href="DTDetail/<?=$uid?>/<?=$tdate?>/3">Total Task Pending - <b><?=$ttd->ad?></b></p></a><hr>
                    <p><a href="DTDetail/<?=$uid?>/<?=$tdate?>/4">Total Task Completed - <b><?=$ttd->ae?></b></p></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/5"><p>Call Assign/Planned- <b><?=$ttd->a?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/6"><p>Call Pending- <b><?=$ttd->b?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/7"><p>Call Completed- <b><?=$ttd->c?></b></a>
                    ...
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/8"><p>Email Assign/Planned- <b><?=$ttd->d?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/9"><p>Email Pending- <b><?=$ttd->e?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/10"><p>Email Completed- <b><?=$ttd->f?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/11"><p>Whatsapp Assign/Planned- <b><?=$ttd->g?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/12"><p>Whatsapp Pending- <b><?=$ttd->h?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/13"><p>Whatsapp Completed- <b><?=$ttd->i?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/14"><p>FTTP Assign/Planned- <b><?=$ttd->j?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/15"><p>FTTP Pending- <b><?=$ttd->k?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/16"><p>FTTP Completed- <b><?=$ttd->l?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/17"><p>RTTP Assign/Planned- <b><?=$ttd->m?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/18"><p>RTTP Pending- <b><?=$ttd->n?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/19"><p>RTTP Completed- <b><?=$ttd->o?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/20"><p>M&E Assign/Planned- <b><?=$ttd->p?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/21"><p>M&E Pending- <b><?=$ttd->q?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/22"><p>M&E Completed- <b><?=$ttd->r?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/23"><p>DIY Assign/Planned- <b><?=$ttd->s?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/24"><p>DIY Pending- <b><?=$ttd->t?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/25"><p>DIY Completed- <b><?=$ttd->u?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/26"><p>Utilisation Assign/Planned- <b><?=$ttd->v?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/27"><p>Utilisation Pending- <b><?=$ttd->w?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/28"><p>Utilisation Completed- <b><?=$ttd->x?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/29"><p>Report Assign/Planned- <b><?=$ttd->y?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/30"><p>Report Pending- <b><?=$ttd->z?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/31"><p>Report Completed- <b><?=$ttd->za?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/32"><p>Other Assign/Planned- <b><?=$ttd->zb?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/33"><p>Other Pending- <b><?=$ttd->zc?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/34"><p>Other Completed- <b><?=$ttd->zd?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/35"><p>Action Taken Yes- <b><?=$ttd->ze?></b></p></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/36"><p>Action Taken No- <b><?=$ttd->zf?></b></p></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/37"><p>Purpose Achieved Yes- <b><?=$ttd->zg?></b></p></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/38"><p>Purpose Achieved No- <b><?=$ttd->zh?></b></p></a>
                    <?php }?>
              </div></div>
              <div class="icon">

              ...
              <div class="card-body box-profile">
                  ...
                  <form action="<?=base_url();?>Menu/stimeline" method="post">
                    ...
                    <div class="was-validated">
                      ...
                      <div class="from-group">
                        <lable>Other Department Visit/PM/ZM 10% each</lable>
                      ...
                      <div class="from-group">
                        <lable>12 OutBond Communication*</lable>
                        <input type="date" class="form-control" name="outbondc" required="">
                      </div>
                      <div class="from-group">
                      ...
                      <div class="form-group text-center">
                        <button type="submit" class="btn btn-success" onclick="this.form.submit(); this.disabled = true;">Set Time Line</button>
                      </div>
...
$('#piaid').on('change', function b() {
var piaid = this.value;
    document.getElementById("pilink").href="https://stemoppapp.in/Menu/MyProfile/"+piaid;
});


$('#pcode').on('change', function b() {
var pcode = this.value;
var piaid = document.getElementById("piaid").value;
document.getElementById("piid").value=piaid;
...
var piaid = this.value;
    $.ajax({
    url:'<?=base_url();?>Menu/getAcademicCalendar',
    type: "POST",
    data: {
        piaid: piaid
    },
...
var piaid = this.value;
    $.ajax({
    url:'<?=base_url();?>Menu/getallpendingtask',
    type: "POST",
    data: {
    piaid: piaid
    },

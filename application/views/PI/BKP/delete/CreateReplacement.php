       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <form action="<?=base_url();?>Menu/modelreplacement" method="post">
                  <div class="form-group">
                    <input type="hidden" value="<?=$uid?>" name="uid">
                    <input type="hidden" value="121212112" name="tid">
                  </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select rounded-0" name="model[]" id="model" multiple>

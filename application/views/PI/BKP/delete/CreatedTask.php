       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                      ...
                      <center>
                      <lable><b>Task Created at : <?=$aotask[0]->sdatet?></b></lable><br>
                      <lable><b>Task Type : <?=$aotask[0]->tasktype?></b></lable><br>
                      <lable><b>Action <?=$aotask[0]->action?></b></lable><br>
                      <lable><b>Remark : <?=$aotask[0]->taskremark?></b></lable><br></center>
                      
                      <?php if($aotask[0]->starttask==''){?>
                      ...
                      <form action="<?=base_url();?>Menu/createaot" method="post">
                          <div class="form-group">
                            <input type="text" class="form-control" placeholder="Closing Remark">
                          </div>
                          <div class="form-group">

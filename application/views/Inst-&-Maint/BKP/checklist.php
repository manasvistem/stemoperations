...
if($page=='page5'){$pagetitle='Post-installation PIA activity check-list From';}
              ...
              <!-- form start -->
                <div class="card-body box-profile">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm">
                        <div class="form-group">
                        <label>Select Installed Model Set Type</label>
                            <select class="form-control" id="mtype" name="mtype">
                                <?php $modelde=$this->Menu_model->get_modeldetail();
                                foreach($modelde as $md){
                                ?>
                                <option value="<?=$md->type?>"><?=$md->detail?></option>
                                <?php } ?>
                            </select>
                        </div>
                        </div>
...
$('#mtype').on('change', function b() {
var mtype = document.getElementById("mtype").value;
   
$.ajax({
url:'<?=base_url();?>Menu/getmodelbytype',
type: "POST",
data: {
mtype: mtype
},

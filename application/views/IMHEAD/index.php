        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-light text-secondary">
              <div class="inner">
                  <?php $day = $this->Menu_model->get_daydbyadimp($tdate); ?>
                ...
                <p><a href="TeamDayDetail/<?=$tdate?>/2">Total Work in Office - <b><?=$day[0]->f?></b></p></a><hr>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
              <a href="TeamDayDetail/<?=$tdate?>/1" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->

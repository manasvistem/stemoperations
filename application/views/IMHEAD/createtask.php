       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <form action="<?=base_url();?>Menu/imtaskassign" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select rounded-0" name="task_type" id="task_type" >
                        ...
                        <option value="gt1">Installation</option>
                        <option value="gt1">Re-Installation</option>
                        <option value="gt11">Delivery</option>
                    </select>
                  </div>
                 ...
                 <div class="form-group">
                    <select class="custom-select rounded-0" name="uname" id="uname">
                      <option value="">Select User</option>
                        <?php $muser = $this->Menu_model->get_user();?>
                        <?php foreach($muser as $mu){if($mu->dep_id=='4'){?>
                        <option value="<?=$mu->id?>"><?=$mu->fullname?></option>
                        <?php }}?>
                    </select> 
                </div>
                  
                <div class="form-group">
                    <input list="brow" class="custom-select rounded-0" name="pcode" id="pcode">
                    <datalist id="brow">

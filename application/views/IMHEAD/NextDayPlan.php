                            ...
                            <div class="table-responsive">
                                <div class="pdf-viwer">
                                    ...
                                    <tbody>
                                        ...
                                        foreach($nxtdtask as $md){if($md->dep_id=='4'){
                                            $startt = $md->plandate;
                                    ...
                                    <?php foreach($nxtdreport as $md){if($md->dep_id=='4'){
                                            $startt = $md->plan;
                                            $startt = date('d-m-Y  h:i A', strtotime($startt));?>
                                    <tr>
                                        <td><?=$i?></td>
                                    ...
                                    <?php foreach($nxtdsummer as $md){if($md->dep_id=='4'){
                                            $startt = $md->plandt;
                                            $startt = date('d-m-Y  h:i A', strtotime($startt));?>
                                    <tr>
                                        <td><?=$i?></td>
                                    ...
                                    <?php foreach($nxtdcuriculum as $md){if($md->dep_id=='4'){
                                            $startt = $md->sdatet;
                                            $startt = date('d-m-Y  h:i A', strtotime($startt));?>
                                    <tr>
                                        <td><?=$i?></td>
                                    ...
                                    <?php foreach($nxtdreview as $md){if($md->dep_id=='4'){
                                            $startt = $md->plant;
                                            $startt = date('d-m-Y  h:i A', strtotime($startt));?>
                                    <tr>
                                        <td><?=$i?></td>

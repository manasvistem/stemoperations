...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="card">
        ...
        <div>
                  <form class="p-3" method="POST" action="<?=base_url();?>Menu/Utilisationbydate">
                                ...
                                <div class="pdf-viwer">
                                    ...
                                    <tbody>
                                      <?php
                                           ...
                                           $ttd=$this->Menu_model->get_utilization($sd,$ed);
                                           foreach($ttd as $ttd){
                                           $sid = $ttd->sid;
                                           $tid = $ttd->tid;
                                           ?>
                                           ...
                                           <td><?=$ttd->zhremark?></td>
                                           <td><a href="<?=base_url();?>Menu/ZipDownload/<?=$tid?>">Downlod</a></td>
                                           </tr>
                                       <?php } ?>
                                  </tbody>
                                </table>

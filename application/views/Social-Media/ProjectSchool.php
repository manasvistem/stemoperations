...
<section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
           <div class="card">
            <form class="p-3" method="POST" action="ProjectSchool">
                
                <input list="pcode" class="m-2" name="projectcode">
                <datalist id="pcode">
                    <option value="">All</option>
                    <?php foreach($client as $c){if($c->projectcode!=''){?>
                        <option><?=$c->projectcode?></option>
                    <?php }}?>
                </datalist>
                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      ...
                                      $i=1; foreach($spd as $d){
                                          $sid = $d->id;
                                          $wg = $this->Menu_model->get_wgbysid($sid);
                                          $re=$this->Menu_model->get_reportsid($sid);
                                      ?>
                                    <tr>
                                        <td><?=$i?></td>
                                        ...
                                        <td><?=$d->sdistrict?></td>
                                        <td><?=$d->sstate?></td>
                                        <td><?php if($wg){?><a href="ZipSchool/<?=$sid?>">Download</a><?php }else{echo 'No DATA';}?></td>
                                    </tr>
                                    <?php $i++;}} ?>
                                  </tbody>
                                </table>

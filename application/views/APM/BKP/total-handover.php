                        ...
                        <div class="table-responsive">
                            <div class="table-responsive">                            
                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      <?php $i=1; foreach($client as $d){
                                          $cid = $d->cid;
                                          $clog = $this->Menu_model->get_handoverlog($cid);
                                          $totallogs=sizeof($clog);
                                      ?>
                                      
                                    <tr>
                                        <td><input type="hidden" name="id[]" value="<?=$i?>"><?=$i?></td>
                                        <td><a href="clientlog/<?=$cid?>"><?=$totallogs?></a></td>
                                        <td><input type="hidden" name="client_name[]" value="<?=$d->client_name?>"><?=$d->client_name?></td>
                                        <td><input type="hidden" name="projectcode[]" value="<?=$d->projectcode?>"><?=$d->projectcode?></td>
                                        <td><input type="hidden" name="mediator[]" value="<?=$d->mediator?>"><?=$d->mediator?></td>
                                        <td><input type="hidden" name="noofschool[]" value="<?=$d->noofschool?>"><a href="client_school/<?=$cid?>"><?=$d->noofschool?></a></td>

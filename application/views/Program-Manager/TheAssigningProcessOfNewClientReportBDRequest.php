          ...
          <div class="card">
            <table class="table table-sm">
              <tbody>
                ...
                <tr class="table-primary">
                  <td>Client Report Remarks</td>
                  <td><?= $bdr[0]->client_report_remarks; ?></td>
                </tr>
                <tr class="table-primary">
                  <td>Report Attachement (Optional)</td>
                  <td>
                  <?php if($d->report_attachement !==''){ ?>
                    <a href="<?= base_url().$bdr[0]->report_attachement; ?>" target="_blank">View</a>
                    <?php }else{ ?>
                                          <span>N/A</span>
                                          <?php } ?>
                </td>
          ...
          <div class="card">
            ...
            <div class="card p-3" style="background:#dcf3ffed">
              ...
              <div class="mb-4" id="inauguration_Card">
                ...
                <hr>
                <?=form_open('Menu/BDRequestAssignToProcessNewClientReport')?>
                <div class="row">
                  <div class="col-md-12">

  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">All Utilisation</h1>
          </div>
          <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card col-12 p-4 text-center">
            <div class="row">
                <?php $i=1; foreach($mdata as $md){?>
                      <div class="col-3 p-3 text-center card card-primary card-outline">
                          <a href="<?=base_url();?>Menu/Utilisation/<?=$md->pid?>">
                          <b><?=$i++?>.</b><br>
                          Project Code<br><b><?=$md->project_code?></b><hr>
                          School Name<br><b><?=$md->sname?></b><hr>
                          Utilisation Uploded by<br><b><?=$md->fullname?></b><hr>
                          Uploded Date<br><b><?=$md->donet?></b></a>
                      </div>
                  <?php } ?>
                  </div>
            </div>

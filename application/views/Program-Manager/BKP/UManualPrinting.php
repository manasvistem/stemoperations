          ...
          <div class="card col-12  p-3 text-center">
             <div class="row">
                  <?php 
                    ...
                    $printing = $this->Menu_model->get_printprocessUM($pcode);
                ?>
                  ...
                  <div class="row p-3 text-center">
                      ...
                      <?php foreach($printing as $print){ 
                          ...
                          $printtask = $this->Menu_model->get_ftrainingmanual($pcode,$process,$part);
                      ?>
                      ...
                      <div class="col-sm-12 col-md-4 col-lg-4 mb-4">
                          <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100">
                            ...
                            <video class="embed-responsive-item img-thumbnail" src="<?=$printtask[0]->video?>" height="300" muted controls></video><hr>
                      </div></div>

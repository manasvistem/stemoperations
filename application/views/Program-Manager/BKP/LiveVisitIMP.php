     ...
     <div class="container-fluid">
        <div class="col-sm col-md-12 col-lg-12 m-auto">
            <div class="card card-primary card-outline p-3">
                <center><h4>Task Summary of IMPs</h4></center><hr>
                <?php date_default_timezone_set("Asia/Kolkata");
                    $aai=1; $date = date('Y-m-d', strtotime('+0 day'));
                    $vtask1=$this->Menu_model->get_livevisitimp1('1',$date);?>
                    ...
                    <div class="row">
                    <?php $vtask2=$this->Menu_model->get_livevisitimp2('1',$date);
     ...
     <div class="container-fluid">
        <div class="col-sm col-md-12 col-lg-12 m-auto">
            <div class="card card-primary card-outline p-3">
                ...
                <?php date_default_timezone_set("Asia/Kolkata");
                    $aai=1;$date = date('Y-m-d', strtotime('+0 day'));
                    $nxtdtask=$this->Menu_model->get_livevisitpendingimp($date);
        ...
        <div class="col-sm col-md-12 col-lg-12 m-auto">
            ...
            <div class="row">
                <?php 
                    ...
                    $nxtdtask=$this->Menu_model->get_livevisitimp('1',$date);
                    $aai=1;
                ...
                <div class="col-12 card p-4"><?=$md->fullname?> | <?=$plant?> | <?=$md->project_code?> | <?=$md->sname?> | <?=$md->task_type?> | <?=$md->taskname?></div>
                   ...
                   <div class="col-lg-2 col-md-3 col-sm-12 <?=$color?> card p-3 border border-white"><center><b>
                       <?=$pt->que?><hr>
                       Expected Time<br><?=$ttime[0]->tasktime?>
                       </b></center>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <input id="submit" type="submit" class="mt-2 bg-danger">
            </div>
</div></div></div>
...
$('#submit').on('click', function() {
	$('#doaction1').modal('hide');
	var tid = document.getElementById("tid").value;
	var remark = document.getElementById("remark").value;
	var remark = document.getElementById("remark").value;
	$.ajax({
    url:'<?=base_url();?>Menu/Reminder',
    type: "POST",
    data: {
    status_id: status_id
    },

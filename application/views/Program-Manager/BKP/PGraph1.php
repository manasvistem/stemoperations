    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>users planed but not Executed Graph</h5></center><hr>
...
<script type="text/javascript">
    ...
    function drawChart12() {
        ...
        <?php
        $graphData = $this->Menu_model->get_uplanbnexegraph($uid, $tdate);
        foreach ($graphData as $row) {
            echo "data.addRow(['Full Name Count', " . $row->fullname_count . "]);";
            echo "data.addRow(['Not Updated Count', " . $row->not_updatedt . "]);";
        }
        ?>

        var options = {
            title: 'User Plan and Not Updated Count',
            is3D: true,
        };

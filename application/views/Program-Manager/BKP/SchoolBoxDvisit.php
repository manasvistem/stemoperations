             ...
             <div class="row">
                ...
                ?>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm p-3 rounded border border-info p-3">
                        <center><h4>School Readiness Call</h4></center>
                  </div>
                  <div class="row p-3 text-center">
                      <?php $fsch = $this->Menu_model->get_SchoolDvisit($pcode); foreach($fsch as $sch){  $sid=$sch->sid;$task = $this->Menu_model->get_spdDeliveryvisit($sid);$cdate=date('Y-m-d H:i:s');?>
                      
                          <div class="col-sm-12 col-md-4 col-lg-4 mb-4">
                              <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100">
                                   <a href="<?=base_url();?>Menu/donedelivery/<?=$sid?>/<?=$task[0]->tid?>">
                               Client Name<br><b><?=$sch->client_name?></b><hr>
                     Project Code<br><b><?=$sch->projectcode?></b><hr>
                     School Name<br><b><?=$sch->sname?></b><hr>
                     Status<br><b><?=$sch->stname?></b><hr>
                     Address<br><b><?=$sch->saddress?>, <?=$sch->scity?>, <?=$sch->sstate?></b><hr>
                     PIA Involve<br><b><?=$sch->pia?></b><hr>
                     IMP Involve<br><b><?=$sch->imp?></b><hr>
                     Last Update On<br><b><?=$updatedt=$sch->spdudt?></b><hr>

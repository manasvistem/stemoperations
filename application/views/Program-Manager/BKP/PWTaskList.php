           ...
           <div class="row">   
             <div class="col-sm col-md-12 col-lg-12">
                ...
                <div class="row">     
                 ...
                 <?php $l= sizeof($tasklist); for($i=0;$i<$tt;$i++){?>
                    <?php if($i<$l){$color='bg-success';} else{$color='bg-danger';} $url='P'.$action.'Detail';?>
                        <?php if($i<$l){ ?> 
                              <div class="col-lg-3 col-md-6 col-sm p-3 <?=$color?> rounded border">
                                 <a href="<?=base_url();?>Menu/<?=$url?>/<?=$pid?>/<?=$tasklist[$i]->tid?>">
                                 <b><?=$tasklist[$i]->task_type?></b><hr>
                                 <b><?=$tasklist[$i]->task_subtype?></b><hr>
                                 <b><?=$tasklist[$i]->fullname?></b><hr>
                                 <b><?=$tasklist[$i]->donet?></b></a>
                              </div>
                         
                        <?php } else{ ?>
                                <div class="col-lg-3 col-md-6 col-sm p-3 <?=$color?> rounded border">
                                 <b><?=$tasklist[0]->task_type?></b><hr>
                                 <b><?=$tasklist[0]->task_subtype?></b><hr>
                                 <b>Not Done</b>
                                </div>
                        <?php } ?>

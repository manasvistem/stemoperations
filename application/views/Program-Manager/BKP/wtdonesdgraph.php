  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>Webinar done for selected date</h5></center><hr>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <canvas id="myChart" width="400" height="200"></canvas>
<script>
<?php 
$tdate =date('Y-m-d');
$ddata= $this->Menu_model->get_wtdonesdgraph($uid, $tdate);?>
        // Data for the chart
        var data = {
            labels: ['num_users (<?=$ddata[0]->num_users?>) ', 'num_tdone (<?=$ddata[0]->num_tdone?>)'],
            datasets: [{
                data: [<?=$ddata[0]->num_users?>, <?=$ddata[0]->num_tdone?>], // Replace with your actual values
                backgroundColor: ['blue', 'red'] // Colors for the chart bars
            }]
        };
        ...
        var myChart = new Chart(ctx, {
            type: 'bar', // You can change the chart type (e.g., 'pie', 'line', etc.) as needed
            data: data,
            options: {
                // Chart options here (e.g., title, legend, etc.)
                scales: {
                    y: {
  ...
  <div class="row">
    <div id="userChart" class="col-6 mt-50" style="width: 900px; height: 500px; "></div>

     ...
     <div class="col-sm col-md-12 col-lg-12 m-auto">
         <div class="card card-primary card-outline">
              <div class="card-body box-profile row">
                                            ...
                                            $handover = "handover";
                                            $handovertask = $this->Menu_model->get_Handovertoinsr($handover);
                                            foreach($handovertask as $ht){ 
                                            $que = $ht->taskname;
                                            $handover = $ht->tasktype;
                                            
                                               ?>
                                           <div class="col-2  card p-3 border border-white"><center><b><?=$que?><hr><?=$handover?></b></center><hr>
                                           </div>
                                    <?php }?>
                            </div>
                        </div>

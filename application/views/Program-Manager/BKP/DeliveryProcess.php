             ...
             <div class="row">
                ...
                ?>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm p-3 rounded border border-info p-3">
                        <center><h4>Delivery Process</h4></center>
                  </div>
                  <div class="row p-3 text-center">
                      <?php $fdeliv = $this->Menu_model->get_deliveryprocess($pcode); foreach($fdeliv as $deli){ ?>
                          <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                              <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100">
                                <b><?=$deli->projectcode?></b><hr>
                                <b>Amount<br> <?=$deli->amount?></b><hr>
                                <img class="card" src="https://stemfactory.in/<?=$deli->receipt?>">
                                <img class="card" src="https://stemfactory.in/<?=$deli->photo1?>" ><hr>
                                <img class="card" src="https://stemfactory.in/<?=$deli->photo2?>" ><hr>
                                <img class="card" src="https://stemfactory.in/<?=$deli->photo3?>" ><hr>
                                <img class="card" src="https://stemfactory.in/<?=$deli->photo4?>" ><hr>
                                <img class="card" src="https://stemfactory.in/<?=$deli->photo5?>" ><hr>

          ...
          <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  ...
                  <div class="form-group">
                            ...
                            <?php foreach($du as $du){ if($du->dep_id==4){?>
                  ...
                  <div class="form-group">
                            ...
                            <select class="custom-select rounded-0" name="bcode" id="bcode" required>
                            <option value="">Select Bag Code</option>
                            <?php foreach($mcode as $d){ if($d->assign==''){?>
                            <option value="<?=$d->bcode?>"><?=$d->bcode?></option>
                            <?php }} ?>
                          </select>
                  </div>
...
$('#dep').on('change', function b() {
var dep = document.getElementById("dep").value;
   
$.ajax({
url:'<?=base_url();?>Menu/getuserbydep',
type: "POST",
data: {
dep: dep
},

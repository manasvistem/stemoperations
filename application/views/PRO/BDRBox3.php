    ...
    <div class="card">
              ...
              <div class="card-body">
                  <div class="container body-content">
                    ...
                    <div class="card col-sm col-md-3 col-lg-3 m-auto p-3 border rounded">
                     <b>Research</b><hr>
                    </div>
                    <div class="card col-sm col-md-3 col-lg-3 m-auto p-3 border rounded">
                     <b>Call</b><hr>
                    ...
                    <div class="card col-sm col-md-3 col-lg-3 m-auto p-3 border rounded">
                     <b>School Details Entry</b><hr>
                    </div>
                    <div class="card col-sm col-md-3 col-lg-3 m-auto p-3 border rounded">
                     <b>Visit</b><hr>
                    </div>
                    <div class="card col-sm col-md-3 col-lg-3 m-auto p-3 border rounded">
                     <b>Upload Document</b><hr>
                    </div>
                    <div class="card col-sm col-md-3 col-lg-3 m-auto p-3 border rounded">
                     <b>ZM/PM Review</b><hr>
                    </div>
                ...
                <?php $bdlogs=$this->Menu_model->get_bdrequestlog($bdrid)?>
        </div>
    </div></div>
    </div>

          ...
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-12 col-lg-12 text-center p-3">
                <h1 class="m-0"><i>Academic Calender Approved Request For PIA</i></h1>
                    ...
                    <div class="card">
                      <div class="card-header" id="headingOne<?=$i?>" style="background:green;color:white; margin: 4px 10px;"  >
                        <div class="row">
                          <div class="col-md-9">
                             <h5 class="mb-0">
                              <button class="btn text-white" style="width:100%" data-toggle="collapse" data-target="#collapseOne<?=$i?>" aria-expanded="true" aria-controls="collapseOne<?=$i?>">
                              <?php
                                ...
                                $approvedcnt = 0;
                                $rejectdcnt = 0;
                                      foreach($uAcedata as $data1){
                                        if($data1->aprovebypm ==1 && $data1->rejectbypm ==0){
                                          $approvedcnt = $approvedcnt+1;
                                        }
                                        if($data1->rejectbypm ==1 && $data1->aprovebypm ==0){
                                          $rejectdcnt = $rejectdcnt+1;
                                        }
                                      }
                              ?>
                              ...
                              <b>Total Approved : </b><?= $approvedcnt ?>
                              <b>Total Reject : </b><?= $rejectdcnt ?>
                              </button>
                            </h5>
                          </div>
                        </div>

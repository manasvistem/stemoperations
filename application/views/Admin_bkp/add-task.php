          ...
          <div class="col-lg-6 col-md-12 col-12 m-auto">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Task (Send Task To any One)</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?=form_open('Menu/addnewtask')?>
                <div class="card-body">
                  <div class="form-group">
                    <label for="slocation">Date</label>
                    <input type="date" class="form-control" name="task" id="date" >
                  </div>
                  <div class="form-group">
                    <label for="slocation">Time</label>
                    <input type="time" class="form-control" name="time" id="time" >
                  </div>
                  <div class="form-group">
                    <label for="sname">Department</label>
                  ...
                  <div class="form-group">
                    <label for="saddress">Person</label>
                  ...
                  <div class="form-group">
                    <label for="slocation">Task</label>
                    <textarea type="text" class="form-control" name="task" id="task" placeholder="Task"></textarea>
                  </div>
                  <div class="form-group">
                    <label for="slanguage">Remark</label>

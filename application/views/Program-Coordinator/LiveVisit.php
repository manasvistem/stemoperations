         ...
         <div class="card card-primary card-outline">
              <div class="card-body box-profile row">
                                        ...
                                        foreach($nxtdtask as $md){
                                           ...
                                           <?php if($vu){if($vu[0]->ans2!=''){?><a href="#" class="pop2"><iframe class="embed-responsive-item img-thumbnail" src="<?=$url2?>" height="300" muted controls allowfullscreen></iframe></a><?php }}?>

              ...
              <div class="card-body box-profile">
                  ...
                  <form action="<?=base_url();?>Menu/checkdayc" method="post">
                    ...
                    <div class="form-group">
                        ...
                        ?>
                            <div class="text-center"><h5><?=$fullname=$md->fullname?> Started Their Day @<?=$ustart?></h5></div>
                            ...
                            $worktime = $this->Menu_model->get_worktime($tdate,$fullname);
                            $worktime = $worktime[0]->worktime;
                            
                            $hours = floor($worktime / 60);
                            $remainingMinutes = $worktime % 60;
                        ...
                        ?>
                            ...
                            <div class="text-center"><h5>Today Total Working Hour@ <?=$time?></h5></div>
                            ...
                            <div class="from-group">
                                <h5 class="text-center"><input type="hidden" name="que[]" value="Enough Time Work">Enough Time Work</h5>
                                <div class="rating">
                                    <input type="radio" name="rat4" value="5" id="21"><label for="21">☆</label>
                                    <input type="radio" name="rat4" value="4" id="22"><label for="22">☆</label>
                                    <input type="radio" name="rat4" value="3" id="23"><label for="23">☆</label>
                                    <input type="radio" name="rat4" value="2" id="24"><label for="24">☆</label>
                                    <input type="radio" name="rat4" value="1" id="25"><label for="25">☆</label>
                                </div>
                            </div>

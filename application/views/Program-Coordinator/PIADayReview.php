       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  ...
                  <h3 class="text-center">PIA Review List (<?=$tdate?>)</h3>
                  <table class="table">
                      <tr>
                          <th>PIA NAME</th>
                          <th>Review</th>
                      </tr>
                  <?php $pia = $this->Menu_model->get_user_pia();
                  foreach($pia as $pia){ ?>
                      <tr>
                          <td><?=$pia->fullname?></td>
                          <td><a href="StartDReview/<?=$pia->id?>"><button type="button" class="btn btn-info">Start Review</button></a></td>
                      </tr> 

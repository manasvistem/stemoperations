                    ...
                    <div class="row">
                            <div class="col-lg-12 p-3 m-auto">
                              <div class="form-group">
                                ...
                                <input type="text" list="procode" id= "projcode" name="indata[]" class="form-control"/>
                                <datalist id="procode">
                              ...
                              <div class="form-group">
                                ...
                                <select name="indata[]" class="form-control" id="year"/>
                                </select>
                              </div>
                              <div class="form-group">
                                <label for="client_name">Attach Installation Report</label>
                                <input type="file" class="form-control" name="filname[]" readonly>
                              </div>
                              <div class="form-group">

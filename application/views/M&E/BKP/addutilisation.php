                ...
                <div class="card-body">
                    <div class="row">
                            <div class="col-lg-12 p-3 m-auto">
                              ...
                              <div class="form-group">
                                <label for="client_name">Report Date</label>
                                <input type="Date" class="form-control" name="indata[2]">
                              </div>
                              <div class="form-group">
                                <label>Select Type</label>
                                <select name="indata[3]" class="form-control"/>
                                    <option>FTTP</option>
                                    <option>TTP</option>
                                    <option>RTTP</option>
                                    <option>DIY</option>
                              ...
                              <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="waimage[]" multiple>
                              </div>
                              <div class="form-group">

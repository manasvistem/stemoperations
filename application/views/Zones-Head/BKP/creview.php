  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Communication Review</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card-body p-2">
          ...
          <div class="col-md-9">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Review Communication</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                   <div class="card-body box-profile">
                    <div class="row">
                    <?php $i=1; if(!$wgd){echo '<h3>No Media File Uploaded</h3>';}else{foreach($wgd as $wg){?>
                    <div class="col-sm col-lg-4">
                           <?php $ext = pathinfo($wg->filepath, PATHINFO_EXTENSION); if($ext=='mp4'){?>
                           <a href="<?=base_url();?><?=$wg->filepath?>" target="_blank">
                              <iframe src="<?=base_url();?><?=$wg->filepath?>" class="img-thumbnail" width="100%"></iframe>
                           </a>
                           <?php }else{?>
                           <a href="<?=base_url();?><?=$wg->filepath?>" target="_blank">
                              <img src="<?=base_url();?><?=$wg->filepath?>"  class="img-thumbnail" width="100%"></iframe>
                           </a>
                           <?php }?>
                        </div>
                       <?php }} ?>

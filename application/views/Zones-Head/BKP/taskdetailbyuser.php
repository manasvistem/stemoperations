  ...
  <div class="content-wrapper">
    ...
    <div class="card">
        ...
        <div>
            ...
            <select name="touser">
                <?php foreach($user as $u){if($u->dep_id==$depid && $u->adminid==$uid){?>
                            ...
                            <div class="table-responsive">
                                <div class="pdf-viwer">
                                    ...
                                    <tbody>
                                      <?php 
                                      $i=0;
                                      foreach($depu as $d){if($d->dep_id==$depid){if($d->adminid==$uid){
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="text-secondary" href="../taskTracker/<?=$sdate?>/<?=$edate?>/Visit/<?=$duid?>"><?=$ttp?></a></td>
                                        <td><a class="text-secondary" href="../taskTracker/<?=$sdate?>/<?=$edate?>/Visit/<?=$duid?>"><?=$pttp?></a></td>
                                        <td><a class="text-secondary" href="../taskTracker/<?=$sdate?>/<?=$edate?>/Visit/<?=$duid?>"><?=$dttp?></a></td>

        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-12 m-auto">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?=base_url();?>Menu/oldschooldata" method="post" enctype="multipart/form-data" id="quickForm">
                <div class="card-body">
                    <div class="row">
                            <div class="col-lg-4 p-3">
                              <div class="form-group">
                                <label>Project Code*</label>
                                <input type="text" list="procode" name="indata[0]" class="form-control" required>
                                <datalist id="procode">
                                    <?php foreach($procode as $d){?>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="indata[35]" placeholder="Client Name" required>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="indata[26]" placeholder="Email Address"  id="exampleInputEmail1" required>
                              </div>
                              <div class="form-group">
                                <label>Address*</label>
                              ...
                              <div class="form-group">
                                <label>State*</label>
                                <input type="text" list="state" name="indata[3]" id="statename"  class="form-control" required>
                                <datalist id="state">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="indata[4]" class="form-control" required>
                              </div>
                        ...
                        <div class="col-lg-4 p-3">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="indata[31]" placeholder="Principal Email ID" required>
                                <lable>+add more</lable>
                              </div>
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="indata[32]" placeholder="Science Teacher Email ID" required>
                                <lable>+add more</lable>
                              </div>
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="indata[33]" placeholder="Mathematics Teacher Email ID" required>
                                <lable>+add more</lable>
                              </div>
                              <div class="form-group">
                                <label>Zone*</label>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="indata[10]" placeholder="Google Location" required>
                              </div>
                              <div class="form-group">
                                <label for="location">Language</label>
                                <input type="text" class="form-control" name="indata[11]" placeholder="Language" required>
                              </div>
                              <div class="form-group">
                                <input type="hidden" class="form-control" name="indata[12]" placeholder="Project of Years"  required>
                              </div> 
                              <div class="form-group">
                        ...
                        <div class="col-lg-4 p-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="indata[28]" placeholder="Total Utilization"  required>
                              </div>
                              <div class="form-group">
                                <label>Whatsapp Group Name</label>
                                <input type="text" class="form-control" name="indata[29]" placeholder="Whatsapp Group Name"  required>
                              </div>
                              <div class="form-group">
                                <label>Whatsapp Group Link</label>
                                <input type="text" class="form-control" name="indata[30]" placeholder="Whatsapp Group Link"  required>
                              </div>
                            <div class="form-group">
                                <label>STD</label>
                                <select name="indata[14]" class="form-control" required>
                                    <option value="1st to 8th">1st to 8th</option>
                                    <option value="5th to 8th">5th to 8th</option>
                                    <option value="1st to 10th">1st to 10th</option>
                                    <option value="5th to 8th">5th to 10th</option>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="indata[15]" required>
                              </div>
                              <div class="form-group">
                                <label for="infrastructure">Total Girls</label>
                                <input type="text" class="form-control" name="indata[16]" required>
                              </div>
                              <div class="form-group">
                                <label for="infrastructure">Total Students</label>
                                <input type="text" class="form-control" name="indata[17]" required>
                              </div>
                              <div class="form-group">
                                <label for="infrastructure">Total Teachers</label>
                                <input type="text" class="form-control" name="indata[18]" required>
                              </div>
                              <div class="form-group">
                                <label for="Timing">Timing</label>
                                <input type="text" class="form-control" name="indata[19]" required>
                              </div>
                              <div class="form-group">
                                <label for="Website">Website</label>
                                <input type="text" id="Website" class="form-control" name="indata[20]" required>
                              </div>
                              <div class="form-group">

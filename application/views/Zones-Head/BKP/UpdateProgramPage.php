            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    ...
                    <div class="card p-2 bg-success text-center">
                        <h5>Update Program WhatsGroup SID</h5>
                    </div>
                    <hr>
                                    ...
                                    <div class="card-header bg-primary" id="headingOne<?=$j?>">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link text-white" data-toggle="collapse" data-target="#collapseOne<?=$j?>" aria-expanded="true" aria-controls="collapseOne">
                                              [ <?=$j ?> ]  School Name -  <?= $this->Menu_model->getSchoolNameBySid($gdata[0]->sid) ?> - <?= $gdata[0]->sid ?>
                                            </button>
                                        </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="row">
                                        ...
                                        foreach($gdata as $pdata1):
                                            if($k == 1){
                                            ?>
                                            <form action="<?=base_url();?>Menu/UpdateProgramPageSID" method="post" id="formbody<?= $pdata1->sid ?>">
                                                <input type="hidden" value="<?= $pdata1->project_code ?>" name="project_code">
                                                <input type="hidden" value="<?= $pdata1->sid ?>" name="old_sid">
                                                <input type="number"name="update_sid" placeholder="Enter right sid" >
                                                <button type="submit" id="update<?= $pdata1->sid ?>" class="btn btn-primary">Update</button>
                                            </form>
                                            <?php } $k++; endforeach; ?>
                                        </div>
                                    </div>
                                ...
                                <table id="example1" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <p><?= $this->Menu_model->getSchoolNameBySid($pdata->sid) ?> - <?= $pdata->sid ?></p> </td>
                                            <td><?= $pdata->type ?></td>
                                            <td><?= $pdata->remark ?></td>
                                            <td>
                                                <a href="<?=base_url();?><?= $pdata->filepath ?>" target="_BLANK" >
                                                <img src="<?=base_url();?><?= $pdata->filepath ?>" width="100" height="100" alt="data not found">
                                                </a>
                                            </td>

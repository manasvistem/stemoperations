          ...
          <div class="container-fluid ">
            <div class="card p-4">
              <div class="card p-2 bg-dark text-center">
                <h3>Annual Program Review Status </h3>
              </div>
              <div class="form-box text-center card p-4">
                <div class="text-right">
                  <a class="bg-gray p-1" href="<?=base_url();?>Menu/StartProgrramReview">Go To Program Review Page</a>
                </div>
                <div class="main_area text-center taskplanfortodays">
                  <div class="bg-white d-flex flex-wrap p-4 border1 mhs_sty mps">
                    ...
                    <span class="p-1">Total Project - <b><?= sizeof($allPcode)?></b></span>
                    </a>
                    <a href="javascript:void(0)" class="icon_sty">
                    <span class="p-1">Complete Project - <b><?= sizeof($comprogram) ?></b></span>
                    </a>
                    <a href="javascript:void(0)" class="icon_sty">
                    <span class="p-1"> Pending - <b><?= sizeof($allPcode)-sizeof($comprogram) ?></b></span>
                    </a>
                  </div>
                </div>
              </div>

           ...
           <div class="col-sm col-md-12 col-lg-12 m-auto">
              <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                        ...
                        <?php if($code=='1'){?><table class="table">
                            <?php $i=1;$query=$this->db->query("SELECT * from spd where zh_id='$uid' and status='7'");
                            $data = $query->result();
                            foreach($data as $da){?>
                                <tr>
                                    <td><?=$i++?></td>
                        ...
                        <?php if($code=='2'){?><table class="table">
                            <?php $i=1;$query=$this->db->query("SELECT * from plantask LEFT JOIN task_assign ON task_assign.id=plantask.taskid LEFT JOIN spd on spd.id=plantask.spd_id where user_id='$uid' and tdone='0'");
                            $data = $query->result();
                            foreach($data as $da){?>
                                <tr>
                                    <td><?=$i++?></td>
                        ...
                        <?php if($code=='3'){?><table class="table">
                            <?php $i=1;$query=$this->db->query("SELECT * FROM task_assign LEFT JOIN spd ON spd.id=task_assign.spd_id where user_id='$uid' plan='0'");
                            $data = $query->result();
                            foreach($data as $da){?>
                                <tr>
                                    <td><?=$i++?></td>

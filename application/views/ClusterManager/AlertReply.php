                            ...
                            <div class="table-responsive">
                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <td><a href="<?=base_url();?>/Menu/alreply/<?=$md->uuid?>/Warning/3/<?=$uid?>">Reminder</a></td>
                                        </tr>
                                    <?php $i++;} ?>
                                  </tbody>
                                </table>
                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td><?=$md->sname?></td>
                                           <td><?=$md->pianame?></td>
                                           <td><?=$md->saddress?>,<?=$md->sdistrict?>,<?=$md->sstate?></td>
                                        </tr>
                                    <?php $i++;} ?>
                                  </tbody>
                                </table>
                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        $data = $this->Menu_model->get_rdonespdid($sid);
                                        if(!$data){
                                        
                                        ?>
                                        <tr>
                                           <td><?=$i?></td>
                                           <td><?=$sp->project_code?></td>
                                           <td><?=$sp->sname?></td>
                                           <td><?=$pi[0]->fullname?></td>
                                           <td><?=$sp->saddress?>,<?=$sp->sdistrict?>,<?=$sp->sstate?></td>
                                        </tr>
                                    <?php $i++;}} ?>
                                  </tbody>
                                </table>
                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        $pcode = $cl->projectcode;
                                        $data = $this->Menu_model->get_rdoneprojectid($pcode);
                                        if(!$data){
                                        ?>
                                        <tr>
                                           <td><?=$i?></td>
                                           <td><?=$cl->projectcode?></td>
                                        </tr>
                                    <?php $i++;}} ?>

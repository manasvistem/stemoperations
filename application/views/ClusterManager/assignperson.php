  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Initiate Installation</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <form action="<?=base_url();?>Menu/assignpiinszh" method="post">
                      <input type="hidden" name="fid" value="<?=$user['id']?>">
                      <input type="hidden" name="zh" value="<?=$user['id']?>">
                  <div class="form-group">
                        <label>Select Client</label>
                        <input list="pcodet" class="form-control" id="pcode">
                        <datalist id="pcodet" name="pcode" required>
                          <option value="">Select Client</option>
                            <?php foreach($nspc as $d){?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" name="datet" min="2022-01-01 00:00:00">
                    </div>
                  <div class="form-group">
                    <label>Region</label>

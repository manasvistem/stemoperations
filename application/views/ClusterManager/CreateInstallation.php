  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Create Installation Task</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <form action="<?=base_url();?>Menu/taskassignins" method="post">
                  <div class="form-group">
                    <label>Date and Time</label>
                    <input type="hidden" class="form-control" name="from_user" id="from_user" value="<?php echo $data['user']['id']; ?>">
                    <input type="datetime-local" class="form-control" name="task_date" id="task_date" min="2022-01-01 00:00:00">
                  </div>
                  <div class="form-group">
                    <label>Person</label>
                    <select class="custom-select rounded-0" name="to_user" id="to_user" >
                        <?php $ins=$this->Menu_model->get_user_bydep(4);?>
                            <?php foreach($ins as $ins){?>
                    ...
                    <div class="form-group">
                        ...
                        <input list="pcodet" class="form-control" name="pcode" id="pcode" required>
                        <datalist  id="pcodet">
                          <option value="">Select Client</option>
                            <?php foreach($spd as $d){if($d->zh_id==$uid){?>
...
$.ajax({
url:'<?=base_url();?>Menu/getallspdbypcode',
type: "POST",
data: {
pcode: pcode
},

  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Create Other Task</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <form action="<?=base_url();?>Menu/assignot" method="post">
                      <div class="form-group">
                          <input type="hidden" name="fuser" value="<?=$uid?>">
                        <label>Task Assign to</label>
                        <select class="form-control" name="touser">
                            <option value="">Select Name</option>
                            <?php foreach($du as $du){if($du->adminid==$uid){?>
                            <option value="<?=$du->id?>"><?=$du->fullname?></option>
                            <?php }} ?>
                        </select>
                      </div>
                      <div class="form-group">
                        <label>Assign Date and Time</label>
                        <input type="datetime-local" class="form-control" name="tadate">
                      </div>
                      <div class="form-group">
                        <label>Target Date and Time</label>
                        <input type="datetime-local" class="form-control" name="ttdate">
                      </div>
                      <div class="form-group">
                        <label>Task Detail</label>
                        <textarea name="taskdetail" class="form-control" ></textarea>
                      </div>
                      <div class="form-group">
                        <label>Remark</label>

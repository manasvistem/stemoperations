           ...
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select rounded-0" name="indata[7]" id="pcode" >
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select rounded-0" name="indata[8]" id="spd_id" >
                        <option value=" ">Select School</option>
                    </select>
                </div>
                <div class="form-group">
                    <label>If Cluster Tranning Select School Name</label>
                    <select class="custom-select rounded-0" name="indata[10][]" id="spd_id1" multiple>
                        <option value=" ">Select School</option>
                    </select>
                </div>
                  <div class="form-group">

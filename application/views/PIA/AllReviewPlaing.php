...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-4">
                            <select class="form-control" name="reviewtype" required="" id="reviewtype">
                                <option value="School Self Review">School Self Review</option>
                                <option value="Program Self Review">Program Self Review</option>
                            </select>
                        </div>
         ...
         <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                  ...
                  <hr>
                    <div class="was-validated">
                    <div class="form-group">
                        <input type="hidden" id="rtype" value="<?=$revst[0]->reviewtype;?>">
              ...
              <div class="card p-3 mt-3">
                  <div class="was-validated">
                  <form action="<?=base_url();?>Menu/closereview" method="post" enctype="multipart/form-data">
     ...
     <div class="col-sm col-md-6 col-lg-6 m-auto">
         <div class="card card-primary card-outline">
             <form action="<?=base_url();?>Menu/rtaskcpi" method="post">
                 <input type="hidden" name="ritype" value="<?=$revst[0]->reviewtype;?>">
              <div class="card-body box-profile" id="spddata"></div>
                  <div class="was-validated m-3">
                    ...
                    <hr>.
                    <div id="psr">
                        <lable>Is program/project come in mandatory category?</lable>
                        <select class="form-control" required="" name="pcategory">
                            <option>yes</option>
                            <option>no</option>
                        </select>
                        
                        <lable>Is case study generated for this project code?</lable>
                        <select class="form-control" required="" name="pcasestudy">
                            <option>yes</option>
                            <option>no</option>
                        </select>
                        
                        <lable>What sort of reports are requested by BD for this project code?</lable>
                        <select class="form-control" required="" name="preports">
                            <option>Monthly</option>
                            <option>Quarterly</option>
                            <option>half yearly</option>
                            <option>Annual</option>
                        </select>
                        <lable>Is there any up sell opportunity?</lable>
                        <select class="form-control" required="" name="psell">
                            <option>yes</option>
                            <option>no</option>
                        </select>
                        <lable>Is schools are located in Aspirational District? </lable>
                        <select class="form-control" required="" name="paspirational">
                            <option>yes</option>
                            <option>no</option>
                        </select>
                        <lable>Is WhatsApp Group created for program?</lable>
                        <select class="form-control" required="" name="pwg">
                            <option>yes</option>
                            <option>no</option>
                        </select>
                        <lable>Is Admin number added in WhatsApp group?</lable>
                        <select class="form-control" required="" name="pwga">
                            <option>yes</option>
                            <option>no</option>
                        </select>
                    </div>
                    ...
                    <div id="ssr">
                            <lable>Is School teachers are Added on WhatsApp Group?</lable><br>
                            <small>note: If Yes. Add screen short of it/If No, add school teacher and upload screen short</small>
                            <input type="file" class="form-control" required="" name="filname">
                            <lable>What is Current Categories of school?</lable>
                            <select class="form-control" required="" name="categories">
                                <option>Client visit ready</option>
                                <option>Focused school</option>
                                <option>Sustainable school</option>
                                <option>Teachers Active</option>
                                <option>Average</option>
                            </select>
                            <lable>What is the Reason for This Categories?</lable>
                            <textarea class="form-control" name="categreason" placeholder="Reason for This Categories..."  required=""></textarea>
                            <lable>What kind of Relation you have build with this school?</lable>
                            <select class="form-control" required="" name="relation">
                                <option>Good</option>
                                <option>Not good</option>
                            </select>
                            <lable>Are you connected with teachers on social Media</lable>
                            <select class="form-control" required="" name="socialmedia">
                                <option>facebook</option>
                                <option>instagram</option>
                                <option>Linkdien</option>
                                <option>Snapchat</option>
                                <option>Twitter</option>
                            </select>
                            <lable>Is school participated in NSP?</lable>
                            <select class="form-control" required="" name="snsp">
                                <option>yes</option>
                                <option>no</option>
                            </select>
                            <lable>How many student participated in NSP?</lable>
                            <input type="number" class="form-control" required="" name="nspno">
                            <lable>Is school Participated in webinar and Summer activity?</lable>
                            <select class="form-control" required="" name="summeractivity">
                                <option>yes</option>
                                <option>no</option>
                            </select>
                            <lable>How many students participated in Summer camp Activities?</lable>
                            <input type="number" class="form-control" required="" name="scno">
                            <lable>Any Support required to school?</lable>
                            <textarea class="form-control" name="support" placeholder="Support required..."  required=""></textarea>
                            <lable>Is DIY activity conducted in last academic year?</lable>
                            <select class="form-control" required="" name="diy">
                                <option>yes</option>
                                <option>no</option>
                            </select>
                            <lable>Is there any up sell opportunity from School?</lable>
                            <select class="form-control" required="" name="opportunity">
                                <option>yes</option>
                                <option>no</option>
                            </select>
                            <lable>Did you get case study from this school?</lable>
                            <select class="form-control" required="" name="casestudy">
                                <option>yes</option>
                                <option>no</option>
                            </select>
                            <lable>What kind of utilization you get from school?</lable>
                            <select class="form-control" required="" name="utilizationtype">
                                <option>Good</option>
                                <option>bad</option>
                                <option>Just Photo</option>
                                <option>Best</option>
                                <option>No utilization</option>
                            </select>
                            <lable>Is school logs after april 2023 activity are as per your plan actions?</lable>
                            <select class="form-control" required="" name="logsactivity">
                                <option>Yes</option>
...
$.ajax({
url:'<?=base_url();?>Menu/getspdbypianst',
type: "POST",
data: {
stid: stid,
piid: piid,

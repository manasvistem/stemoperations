  ...
  <form method="POST" action="<?= base_url();?>Menu/submitClusterRoundData" name="NSPClusterRound" enctype="multipart/form-data" >
    ...
    <div class="card shadow border-0">
      <div class="card-body">
        ...
        <!-- Start NSP Time -->
        <div class="mb-3">
  <label class="form-label">NSP Started At:</label><br>  <input type="text" id="nspStartTime" class="form-control mt-2 d-none" name="nspStartTime" readonly>
...
<div id="nspFields" style="display: none;">
  <!-- All the rest of the fields go here, wrap them inside this div -->
        ...
        <!-- School Selection -->
        <div class="mb-3">
          <label class="form-label"><input type='checkbox' name='schoolname[]' value='all' >Select Participated School</label>
          <?php 
        ...
        <div class="row g-3">
          ...
          <div class="col-md-4">
            <label class="form-label">DIY - 3nd Place</label>

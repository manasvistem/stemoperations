          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-light text-secondary"> 
              <div class="inner">
                ...
                <?php $ttd=$this->Menu_model->get_tdetailbyuser($uid,$tdate);
                      foreach($ttd as $ttd){?>
                    <p><a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/1">Pending Task to be Schedule - <b><?=$ttd->ab?></b></p></a><hr>
                    <p><a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/2">Total Task Assign/Planned - <b><?=$ttd->ac?></b></p></a><hr>
                    <p><a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/3">Total Task Pending - <b><?=$ttd->ad?></b></p></a><hr>
                    <p><a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/4">Total Task Completed - <b><?=$ttd->ae?></b></p></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/5"><p>Call Assign/Planned- <b><?=$ttd->a?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/6"><p>Call Pending- <b><?=$ttd->b?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/7"><p>Call Completed- <b><?=$ttd->c?></b></a>
                    ...
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/8"><p>Email Assign/Planned- <b><?=$ttd->d?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/9"><p>Email Pending- <b><?=$ttd->e?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/10"><p>Email Completed- <b><?=$ttd->f?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/11"><p>Whatsapp Assign/Planned- <b><?=$ttd->g?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/12"><p>Whatsapp Pending- <b><?=$ttd->h?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/13"><p>Whatsapp Completed- <b><?=$ttd->i?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/14"><p>FTTP Assign/Planned- <b><?=$ttd->j?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/15"><p>FTTP Pending- <b><?=$ttd->k?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/16"><p>FTTP Completed- <b><?=$ttd->l?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/17"><p>RTTP Assign/Planned- <b><?=$ttd->m?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/18"><p>RTTP Pending- <b><?=$ttd->n?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/19"><p>RTTP Completed- <b><?=$ttd->o?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/20"><p>M&E Assign/Planned- <b><?=$ttd->p?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/21"><p>M&E Pending- <b><?=$ttd->q?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/22"><p>M&E Completed- <b><?=$ttd->r?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/23"><p>DIY Assign/Planned- <b><?=$ttd->s?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/24"><p>DIY Pending- <b><?=$ttd->t?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/25"><p>DIY Completed- <b><?=$ttd->u?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/26"><p>Utilisation Assign/Planned- <b><?=$ttd->v?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/27"><p>Utilisation Pending- <b><?=$ttd->w?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/28"><p>Utilisation Completed- <b><?=$ttd->x?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/29"><p>Report Assign/Planned- <b><?=$ttd->y?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/30"><p>Report Pending- <b><?=$ttd->z?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/31"><p>Report Completed- <b><?=$ttd->za?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/32"><p>Other Assign/Planned- <b><?=$ttd->zb?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/33"><p>Other Pending- <b><?=$ttd->zc?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/34"><p>Other Completed- <b><?=$ttd->zd?></b></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/35"><p>Action Taken Yes- <b><?=$ttd->ze?></b></p></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/36"><p>Action Taken No- <b><?=$ttd->zf?></b></p></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/37"><p>Purpose Achieved Yes- <b><?=$ttd->zg?></b></p></a><hr>
                    <a href="DTDetail/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/38"><p>Purpose Achieved No- <b><?=$ttd->zh?></b></p></a>
                    <?php }?>
              </div></div>
              <div class="icon">
            ...
            <div class="small-box bg-light text-secondary"> 
              <div class="inner">
                ...
                <?php foreach($status as $st){?>
                 <p><a href="pischool/<?=$uid?>/0">Total School - <b><?=$st->a;?></b></p></a><hr>
                 <p><a href="pischool/<?=$uid?>/1">New School - <b><?=$st->b;?></b></p></a><hr>
                 <p><a href="pischool/<?=$uid?>/2">FTTP Done - <b><?=$st->c;?></b></p></a><hr>
                 <p><a href="pischool/<?=$uid?>/3">Utilization Initiated School - <b><?=$st->d;?></b></p></a><hr>
                 <p><a href="pischool/<?=$uid?>/7">Inactive School - <b><?=$st->h;?></b></p></a><hr>
                 <p><a href="pischool/<?=$uid?>/4">Average School - <b><?=$st->e;?></b></p></a><hr>
                 <p><a href="pischool/<?=$uid?>/5">Good School - <b><?=$st->f;?></b></a>
                 ...
                 <p><a href="pischool/<?=$uid?>/6">Model School - <b><?=$st->g;?></b></p></a><hr>
                 <p><a href="pischool/<?=$uid?>/8">Client Readiness School - <b><?=$st->i;?></b></p></a><hr>
                <?php } ?>
              </div></div>
              <div class="icon">
                <i class="ion ion-person-add"></i>
            ...
            <div class="card card-primary card-outline card-outline-tabs">
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-four-tabContent">
                  ...
                  <div class="tab-pane fade" id="custom-tabs-four-virtual" role="tabpanel" aria-labelledby="custom-tabs-four-call-tab">
                      <?php 
                      $aai=0;
              ...
              <div class="card-body">
                  <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
                        <ul id="myUL">
                          ...
                          <?php }else{ $pending=$this->Menu_model->get_provisiont($lstttid);
                          $pendinguser=$this->Menu_model->get_user_byid($pending[0]->to_user);
                          $pendingspd=$this->Menu_model->get_spdbyid($pending[0]->spd_id);
                          echo '<b class="text-danger">Provisions Task Pending from '.$pendinguser[0]->fullname.'<b><br>';
                          echo $pending[0]->task_type.'('.$pending[0]->task_subtype.') | '.$pendingspd[0]->project_code.' | '.$pendingspd[0]->sname;
                          } ?>
                          </strong></a></li>
                            <?php $ai++;} ?>
                        </ul>

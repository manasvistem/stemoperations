    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>Open BD Request Type Wise</h5></center><hr>
...
<div id="piechart3d3" style="width: 100%; height: 500px;"></div>
  ...
  <script type="text/javascript">
        ...
        function drawChart12() {
          ...
          <?php
          $code='10';
          $status = $this->Menu_model->get_BDRbyPIA1($uid);
          foreach ($status as $st) {
            $statusName = $st->rtype . " (" . $st->cont . ")";
            echo "data.addRow(['$statusName', $st->cont, '$st->rysn', '$uid']);";
          }
          ?>
          var options = {
            is3D: true,
          ...
          google.visualization.events.addListener(chart, 'select', function() {
            ...
            if (selection) {
              var rysn = data.getValue(selection.row, 2);
              var uuid = data.getValue(selection.row, 3);
              var code = 10;
              window.location.href = '<?=base_url();?>Menu/RBDOP/' + rysn + '/' + code;
            }
          });
          ...
          <div class="card col-12  p-3 text-center">
              ...
              <div class="container-fluid card p-5" id="data-container">
                <div class="row text-center" id="grid-view">
                     <?php $BDRequest = $this->Menu_model->get_BDRequestbyPIA($rysn,$code,$uid);
                ...
                <div id="list-view" style="display: none;">
                		...
                		<table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <?php $BDRequest = $this->Menu_model->get_BDRequestbyPM($rysn,$code);

            ...
            <div class="card card-primary">
              ...
              <form action="<?=base_url();?>Menu/utilisationsubmit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                            <div class="col-lg-12 p-3 m-auto">
                              ...
                              <div class="form-group" id="photo">
                                ...
                                <input type="file" class="form-control" name="waimage[]" id="filname2" multiple disabled onchange="uploadFile()">
                              </div>
                ...
                <div class="card-footer">
                  <input type="submit" class="btn btn-primary" id="submit" onclick="this.form.submit(); this.disabled = true;">
                </div>
              </form>
            </div>
            <!-- /.card -->

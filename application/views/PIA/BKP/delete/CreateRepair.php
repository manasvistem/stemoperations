  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Replacement Model</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <form action="<?=base_url();?>Menu/modelrepair" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select rounded-0" name="model" id="model">
                        <option value="">Select Replacement Model</option>
                    </select>
                </div>
                <div class="form-group">
                    <label>Part Name</label>
                    <textarea class="form-control" name="part_name" id="part_name" placeholder="Part Name" ></textarea>
                  </div>

    ...
    <section class="content">
      <div class="container-fluid">
       <div class="card col-12  p-3 text-center">
              <center><h5>Between dates wise Holidays</h5></center><hr>	
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
  <script type="text/javascript">
        ...
        function drawChart12() {
          ...
          <?php
          $status = $this->Menu_model->get_pig2($uid);
          foreach ($status as $st) {
            $statusName = $st->sdatet. " to " .$st->todate." (" .$st->dated. ")";
            echo "data.addRow(['$statusName', $st->dated, '', '$uid']);";
          }
          ?>
          var options = {
            is3D: true,

       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">				
                  ...
                  <div class="form-group">
                    <label>Selecy Holiday</label>
                    <select class="custom-select rounded-0" name="type">
                        <option>Gove Holydays</option>
                        <option>Exam Date</option>
                        <option>Winter Week</option>
                        <option>Summer Week</option>
                        <option>District science Fear</option>
                        <option>State science Fear</option>
                        <option>Other</option>
                  </select>
                  </div>
                  <div class="form-group">

    ...
    <section class="content">
      <div class="container-fluid">
       <div class="card col-12  p-3 text-center">
              <center><h5>Day of Holidays Type wise</h5></center><hr>
                <div class="row">
                  ...
                  <script type="text/javascript">
                        ...
                        function drawChart12() {
                          ...
                          foreach ($status as $st) {
                            $statusName = $st->type."(".$st->gcremark.") (" . $st->cont . ")";
                ...
                <div id="list-view" style="display: none;">
                   ...
                   <div id="tabular-view" style="display: none;">
                        <div class="card p-3 col-lg-4 col-sm m-auto bg-light">
                          ...
                          $status = $this->Menu_model->get_pig1($uid);
                          foreach ($status as $st) {?>
                          <b><a href="<?=base_url();?>Menu/PIRGraph1//"><?=$st->type?> - <?=$st->cont?></a></b><hr>
                          <?php } ?>
                          <b><a href="<?=base_url();?>Menu/PIRGraph1/<?=$code?>">View All</a></b>
                    </div>
                </div>  
                </div>

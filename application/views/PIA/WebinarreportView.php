...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/WebinarActivityreportSubmit" enctype="multipart/form-data" method="post">

...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/WinterActivityreportSubmit" enctype="multipart/form-data" method="post">

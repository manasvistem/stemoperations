...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/WinterActivitySubmit" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3 text-center">
      ...
      if ($main_task_id == 375 || $main_task_id == 376 || $main_task_id == 377 || $main_task_id == 378 || $main_task_id == 379) {
        if ($main_task_id == 375) {
          $uploadBtn_message = "⬆️ Submit";
          $takeSalify = "📷 Take Salify";
        } else if ($main_task_id == 376) {
          $uploadBtn_message = "⬆️ Upload";
          $takeSalify = "📷 Upload Ongoing Winter Activity First Screen Short ";
        }else if ($main_task_id == 377) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Winter Activity Second Screen Short ";
          }else if ($main_task_id == 378) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Winter Activity Third Screen Short ";
          }else if ($main_task_id == 379) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Winter Activity Fouth Screen Short ";
          }
      ?>
<?php 
if ($main_task_id == 375) {

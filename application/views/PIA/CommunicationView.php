...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/CommunicationSubmit" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3 text-center">
      ...
      if ($main_task_id == 442 || $main_task_id == 443 || $main_task_id == 444 || $main_task_id == 445 || $main_task_id == 446) {
        $uploadBtn_message = "⬆️ Submit";
        if ($main_task_id == 442 ) {
        $takeSalify = "📷 Upload Communication Screen Shot";
        }else if($main_task_id == 443){
            $takeSalify = "📷 Upload Second Communication Screen Shot";
        }else if($main_task_id == 444){
            $takeSalify = "📷 Upload Third Communication Screen Shot";
        }else if($main_task_id == 445){
            $takeSalify = "📷 Upload Fourth Communication Screen Shot";
        }else if($main_task_id == 446){
            $takeSalify = "📷 Upload Fifth Communication Screen Shot";
        }
      ?>

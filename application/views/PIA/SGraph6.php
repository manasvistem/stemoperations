    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>Year Wise Project Graph</h5></center><hr>
...
<div id="piechart3d3" style="width: 100%; height: 500px;"></div>
  ...
  <script type="text/javascript">
    ...
    function drawChart12() {
      ...
      <?php
      $client_handover = $this->Menu_model->get_SPDbypipyearw($uid);
      ...
      google.visualization.events.addListener(chart, 'select', function () {
        ...
        if (selection) {
          ...
          window.location.href = '<?= base_url(); ?>Menu/SGraph6/' + projectYear + '/' + code;
        }
      });
          ...
          <div class="card col-12  p-3 text-center">
              ...
              <div class="container-fluid card p-5" id="data-container">
                <div class="row text-center" id="grid-view">
                    ...
                    <?php 
                         $mdata = $this->Menu_model->get_schoolbycode5($uid,$stid,$code);
                         foreach($mdata as $dt){
                ...
                <div id="tabular-view" style="display: none;">
                    ...
                    <?php
                      $status = $this->Menu_model->get_SPDbypipyearw($uid);

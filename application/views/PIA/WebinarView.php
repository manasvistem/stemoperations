...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/WebinarActivitySubmit" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3 text-center">
      ...
      if ($main_task_id == 345 || $main_task_id == 346 || $main_task_id == 347 || $main_task_id == 348 || $main_task_id == 349) {
        if ($main_task_id == 345) {
          $uploadBtn_message = "⬆️ Submit";
          $takeSalify = "📷 Take Salify";
        } else if ($main_task_id == 346) {
          $uploadBtn_message = "⬆️ Upload";
          $takeSalify = "📷 Upload Ongoing Webinar First Screen Short ";
        }else if ($main_task_id == 347) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Webinar Second Screen Short ";
          }else if ($main_task_id == 348) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Webinar Third Screen Short ";
          }else if ($main_task_id == 349) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Webinar Fouth Screen Short ";
          }
      ?>
<?php 
if ($main_task_id == 345) {

...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/OutbondCommunicationSubmit" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3 text-center">
      ...
      if ($main_task_id == 406 || $main_task_id == 407 || $main_task_id == 408) {
            
        if ($main_task_id == 406 || $main_task_id == 407) {
            $uploadBtn_message = "⬆️ Submit";
            $takeSalify = "📷 Upload file";
...
<?php if($main_task_id == 406 || $main_task_id == 407) { ?>

    <div class="mb-4">
        <select class="form-select" id="exampleFormControlSelect1" name="creative_done_by_PIA" aria-label="Default select example">
        ...
        <div class="input-group-capture" id="UploadCard">
...
<?php }else{
    ...
    if ($main_task_id == 408) {
        ...
        $takeSalify = "📷 Upload screen Short";
    }
    ?>

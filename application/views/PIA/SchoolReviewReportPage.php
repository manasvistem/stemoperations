...
<html lang="en">
  <head>
    ...
    <title>Annual School Review Report | STEM LEARNING PVT LTD </title>
        ...
        <div class="content-header">
          <div class="container-fluid ">
            ...
            <div class="card p-3 text-center text-right bg-info ">
              <h3> <i>Annual School Review Report</i> </h3>
            </div>
            <?php 
              // dd($getcslist);
              ?>
              ...
              <div id="accordion">
                <div class="">
                  <div class="card">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <h5 class="mb-0">
                            ...
                            <b>School Review Status : </b>  Complete | No of Complete School - <?= sizeof($getcslist); ?>
                            </a>
                          </h5>
                        </div>
                      </div>
                        ...
                        <div class="card table-responsive">
                          <table id="example1" class="table table-striped">
                            ...
                            <tbody>
                              <?php 
                                $l=1;
                                foreach($getcslist as $comSch){
                                  ?>
                              <tr>
                                <td><?= $l ?></td>
                                <td>
                                  <a target="_BALNK" href="<?=base_url();?>Menu/SchoolReviewDetailsByID/<?= $comSch->sid ?>">
                                  <?= $this->Menu_model->getSchoolNameBySid($comSch->sid)?>
                                  </a>
                                </td>
                                <td><?= $comSch->start_date?></td>
                                <td><?= $comSch->end_date?></td>
                                <td><?= $comSch->schoolreviewtime?></td>
                              </tr>
                              <?php $l++; } ?>
                            </tbody>
                          </table>
                    ...
                    <!--<br>-->
                    <!--<div class="card-header bg-warning" id="headingOne1">-->
                    <!--  <div class="row">-->
                    <!--    <div class="col-md-12">-->
                    <!--      <h5 class="mb-0">-->
                    ...
                    <!--        <b>School Review Status : </b>  Pending | No of Pending - <?= sizeof($getpslist); ?>-->
                    <!--        </a>-->
                    <!--      </h5>-->
                    <!--    </div>-->
                    <!--  </div>-->
                    ...
                    <!--        <tbody>-->
                        <?php 
                                // $l=1;
                                // foreach($getpslist as $penSch){
                       ?>
                    <!--          <tr>-->
                    <!--            <td><?= $l ?></td>-->
                    <!--            <td><?= $penSch->project_code?></td>-->
                    <!--            <td>-->
                    <!--              <?= $penSch->sname?>-->
                    <!--            </td>-->
                    <!--          </tr>-->

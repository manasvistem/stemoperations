    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>Year Wise School Graph</h5></center><hr>
...
<div id="piechart3d3" style="width: 100%; height: 500px;"></div>
  ...
  <script type="text/javascript">
    ...
    function drawChart12() {
      ...
      data.addColumn('string', 'project_year');
      ...
      <?php
      $client_handover = $this->Menu_model->get_SPDbypisyearw($uid);
      foreach ($client_handover as $st) {
        $project_year = $st->project_year . " (" . $st->cont . ")";
        echo "data.addRow(['$project_year', $st->cont, '$st->project_year', '$uid']);";
      }
      ?>
      ...
      google.visualization.events.addListener(chart, 'select', function () {
        ...
        if (selection) {
          var projectYear = data.getValue(selection.row, 2);
          var uuid = data.getValue(selection.row, 3);
          var code = 1;
          // Redirect to another URL with projectYear and uuid as parameters
          window.location.href = '<?= base_url(); ?>Menu/SGraph5/' + projectYear + '/' + code;
        }
      });
          ...
          <div class="card col-12  p-3 text-center">
              ...
              <div class="container-fluid card p-5" id="data-container">
                <div class="row text-center" id="grid-view">
                    ...
                    <?php 
                         $mdata = $this->Menu_model->get_schoolbycode4($uid,$stid,$code);
                         foreach($mdata as $dt){
                    ...
                    ?>
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-4 mb-4 filter-item">
                          <div class="card p-3 border rounded border-success hover-div d-flex flex-column align-items-stretch h-100 text-dark">
                                 Project Year<br><b><?=$dt->sayear?></b><hr>
                ...
                <div id="tabular-view" style="display: none;">
                    ...
                    <?php
                      $status = $this->Menu_model->get_SPDbypisyearw($uid);
                      foreach ($status as $st) {?>
                      <b><a href="<?=base_url();?>Menu/SGraph5/<?=$st->project_year?>/<?=$code?>"><?=$st->project_year?> - <?=$st->cont?></a></b><hr>
                      <?php } ?>
                      <b><a href="<?=base_url();?>Menu/SGraph5/<?=$code?>">View All</a></b>
                      </div>
                </div>  

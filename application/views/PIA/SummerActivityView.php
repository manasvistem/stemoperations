...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/SummerActivitySubmit" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3 text-center">
      ...
      if ($main_task_id == 390 || $main_task_id == 391 || $main_task_id == 392 || $main_task_id == 393 || $main_task_id == 394 || $main_task_id == 395) {
        if ($main_task_id == 390) {
          $uploadBtn_message = "⬆️ Submit";
          $takeSalify = "📷 Take Salify";
        } else if ($main_task_id == 391) {
          $uploadBtn_message = "⬆️ Upload";
          $takeSalify = "📷 Upload Ongoing Summer Activity First Picture / Video";
        }else if ($main_task_id == 392) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Summer Activity Second Picture / Video";
          }else if ($main_task_id == 393) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Summer Activity Third Picture / Video";
          }else if ($main_task_id == 394) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Summer Activity Fouth Picture / Video";
          }else if ($main_task_id == 395) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Summer Activity Fifth Picture / Video";
          }
      ?>
<?php 
if ($main_task_id == 390) {
    $remarks = 'Virtul Meeting Link';
    $uploadBtn_message = 'Submit';
    ?>
<textarea class="form-control" name="meetings_links" id="exampleFormControlTextarea1" rows="3" placeholder="<?=$remarks?>" required></textarea>
<?php } else { ?>
...
<?php } ?>
      ...
      <?php } else { ?>
        ...
        <?php if ($main_task_id == 396) {
          $uploadBtn_message = "Final Remark";
          $remarks = " Write Final Remarks And Close Activity";
        } ?>

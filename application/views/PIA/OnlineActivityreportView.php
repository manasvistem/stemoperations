...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/OnlineActivityreportSubmit" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3 text-center">
      ...
      if ($main_task_id == 367 || $main_task_id == 368 || $main_task_id == 369 || $main_task_id == 370) {
        if ($main_task_id == 367) {
          $uploadBtn_message = "⬆️ Submit";
          $takeSalify = "📷 Upload 1st Page Report Screen Short";
        } else if ($main_task_id == 368) {
          $uploadBtn_message = "⬆️ Upload";
          $takeSalify = "📷 Upload 2nd Page Report Screen Short";
        }else if ($main_task_id == 369) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload 3rd Page Report Screen Short";
          }else if ($main_task_id == 370) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Final Report";
          }
      ?>
<?php 
if ($main_task_id == 360) {

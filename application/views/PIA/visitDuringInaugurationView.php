<div class="container">
    <div class="container-fluid">
        ...
        <form name="meeting_inauguration" id="visitmeetingForm" action="<?= base_url();?>/Menu/updateVisitInauguration" method="post" enctype="multipart/form-data">
            <!-- First Row -->
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="NotWorkingModel" class="form-control">
                            <?php foreach($nonworking_modellist as $key=>$val)
                            { ?>

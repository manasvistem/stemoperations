...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/OnlineActivitySubmit" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3 text-center">
      ...
      if ($main_task_id == 360 || $main_task_id == 361 || $main_task_id == 362 || $main_task_id == 363 || $main_task_id == 364) {
        if ($main_task_id == 360) {
          $uploadBtn_message = "⬆️ Submit";
          $takeSalify = "📷 Take Salify";
        } else if ($main_task_id == 361) {
          $uploadBtn_message = "⬆️ Upload";
          $takeSalify = "📷 Upload Ongoing Online Activity First Screen Short ";
        }else if ($main_task_id == 362) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Online Activity Second Screen Short ";
          }else if ($main_task_id == 363) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Online Activity Third Screen Short ";
          }else if ($main_task_id == 364) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Ongoing Online Activity Fouth Screen Short ";
          }
      ?>
<?php 
if ($main_task_id == 360) {

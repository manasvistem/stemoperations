...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/SummerActivityReportSubmit" enctype="multipart/form-data" method="post">

...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/OnlineDemoSubmit" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3 text-center">
      ...
      if ($main_task_id == 758 || $main_task_id == 759 || $main_task_id == 760) {
        if ($main_task_id == 758) {
          $uploadBtn_message = "⬆️ Submit";
          $takeSalify = "📷 Take Salify";
        } else if ($main_task_id == 759) {
          $uploadBtn_message = "⬆️ Upload";
          $takeSalify = "📷 Upload 1 Screen Short ";
        }else if ($main_task_id == 760) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Share Last Screen Short";
          }
      ?>
<?php 
if ($main_task_id == 758) {
...
<?php } ?>
      ...
      <?php } else { ?>
        ...
        <?php if ($main_task_id == 761) {
          $uploadBtn_message = "Submit Final Remark";

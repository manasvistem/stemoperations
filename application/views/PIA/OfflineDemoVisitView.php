...
<div class="modal-body" id="visitDuringBaseline">
  ...
  <form action="<?= base_url() ?>Menu/OfflineDemoVisitSubmit" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3 text-center">
      ...
      if ($main_task_id == 747 || $main_task_id == 748 || $main_task_id == 749 || $main_task_id == 750 || $main_task_id == 751 || $main_task_id == 752) {
        if ($main_task_id == 747) {
          ...
          $capture = 'capture="environment"';
          $takeSalify = "📷 Take selfie at Venue ";
        }else if ($main_task_id == 749) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload  Running photo 1 ";
          }else if ($main_task_id == 750) {
            $uploadBtn_message = "⬆️ Upload";
            $takeSalify = "📷 Upload Running Video 1 ";
          }else if ($main_task_id == 751) {
            $uploadBtn_message = "⬆️ Upload";
    ...
    <div class="input-group-capture">
        <input type="file" class="form-control d-none" id="inputGroupFile02" name="<?=$upload_name;?>" <?=$capture?> <?=$multiple;?>>
        <hr>
        <!-- Capture Button -->

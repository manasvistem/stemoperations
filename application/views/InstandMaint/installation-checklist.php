  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Installation Checklist</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body box-profile">
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    ...
                    <input type="date" name="indata[]" class="form-control mt-1">
                  </li>
                  <li class="list-group-item">
                    <lable><b>School Name</b></lable>
                    <input type="hidden" name="indata[]" value="<?=$spd[0]->id?>" class="form-control mt-1">
                    <input type="text" value="<?=$spd[0]->sname?>" class="form-control mt-1">
                  </li>
                  <li class="list-group-item">
                    <lable><b>Installation Person</b></lable>
                    <input type="hidden" name="indata[]" value="<?=$uid?>" class="form-control mt-1">
                    <input type="text" value="<?=$user['fullname']?>" class="form-control mt-1">
                  </li>
                  <li class="list-group-item">
                    <lable><b>Address</b></lable>
                    <input type="text" name="indata[]" value="<?=$spd[0]->saddress?>" class="form-control mt-1">
                  </li>
                  <li class="list-group-item">
                    <lable><b>City</b></lable>
                    <input type="text" name="indata[]" value="<?=$spd[0]->scity?>" class="form-control mt-1">
                  </li>
                  <li class="list-group-item">
                    <lable><b>State</b></lable>
                    <input type="text" name="indata[]" value="<?=$spd[0]->sstate?>" class="form-control mt-1">
                  </li>
          ...
          <div class="col-md-9">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Installation Checklist</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body box-profile">
                    ...
                    <div class="row">
                        ...
                        <label>Select Not Delive Model</label>
                        <div class="select2-purple">
                            <select class="select2" multiple="multiple" data-placeholder="Select Model" data-dropdown-css-class="select2-purple" name="ndel[]">
                             <?php foreach($model as $d){ ?>
                ...
                <ul class="list-group list-group-unbordered mb-3">
                      <lable><b>Other Materials</b></lable>

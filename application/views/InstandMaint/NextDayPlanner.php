            ...
            <div class="card card-primary">
              ...
              <div class="card-body box-profile p-5">
                <!-- form start -->
                        ...
                        <span class="badge p-2 m-1 bg-info" >Installation&nbsp;&nbsp;<span class="badge bg-light"></span></span>
                        <span class="badge p-2 m-1 bg-info" >Maintenance&nbsp;&nbsp;<span class="badge bg-light"></span></span>

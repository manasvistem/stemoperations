...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="<?=base_url();?>Menu/modelnwrr" method="post" enctype="multipart/form-data">
          <input type="text" name="sid" value="<?=$spd[0]->id?>">
      ...
      <div class="container-fluid">
        ...
        <div class="card-body p-2">
          ...
          <div class="col-md-9">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Not Working Model</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                <div class="card-body box-profile">
                    <div class="row">
                        <div class="col-md-4 col-lg-4 col-sm m-3">
                        <div class="form-group">
                        <label>Select Repaired Model</label>
                        <div class="select2-purple">
                            <select class="select2" multiple="multiple" data-placeholder="Select Model" data-dropdown-css-class="select2-purple" name="repaired[]">
                    ...
                    <div class="col-md-4 col-lg-4 col-sm m-3">
                        ...
                        <div class="form-group">
                            <label>Select to be Repair Model</label>
                            <div class="select2-purple">
                                <select class="select2" multiple="multiple" data-placeholder="Select Model" data-dropdown-css-class="select2-purple" name="repair[]">
                                    <option>Select model &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                                 <?php foreach($model as $d){ ?>
                                    <option value="<?=$d->model_name?>"><?=$d->model_name?></option>
                                    <?php } ?>
                        ...
                        <div class="col-md-4 col-lg-4 col-sm m-3">
                        <div class="form-group">
                        <label>Select to be Replace Model</label>
                        <div class="select2-purple">
                            <select class="select2" multiple="multiple" data-placeholder="Select Model" data-dropdown-css-class="select2-purple" name="replace[]">
                                <option>Select model &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                             <?php foreach($model as $d){ ?>
                                <option value="<?=$d->model_name?>"><?=$d->model_name?></option>
                                <?php } ?>
                  ...
                  <li class="list-group-item">
                    ...
                    <div class="form-group clearfix mt-2">
                      <div class="icheck-primary d-inline">
                            <div>
                                <input type="hidden" name="mname[]" class="from-control" value="<?=$d->model_name?>">
                                <input type="file" name="filname[]" class="from-control">
                      </div>
                    </div>
                  </li><?php $i++; } ?>
                </ul>

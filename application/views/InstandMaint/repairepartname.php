                ...
                <div class="card-body box-profile">
                    <div class="row">
                        <div class="col-sm-12 col-lg-12">
                            <b class="text-info">Right Remark for Repaired Model</b>
                                <?php
                                $i=1;
                                foreach($model as $d){if($d->status=='Close'){
                                ?>
                                <br><b><?=$i?>. <?echo $modelnname=$d->model_name?></b>
                                    <textarea name="remark[]" class="form-control" requierd></textarea>
                                    <input type="file" name="filname[]" class="form-control" requierd>
                                <?php $i++; }} ?>
                        </div>
                        <div class="col-sm-12 col-lg-12">
                            <b class="text-info">Right Remark for to be Repaire Model</b>
                                <?php
                                $i=1;
                                foreach($model as $d){if($d->status=='Open'){
                                ?>
                                <br><b><?=$i?>. <?echo $modelnname=$d->model_name?></b>
                                    <textarea name="remark[]" class="form-control" requierd></textarea>
                                <?php $i++; }} ?>
                        ...
                        <div class="col-sm-12 col-lg-12">
                            <b class="text-info">Right Remark for Replace Model</b>
                              <?php
                                $i=1;
                                foreach($modelr as $d){if($d->status=='Open'){
                                ?>
                                <br><b><?=$i?>. <?=$d->model_name?></b>
                                <textarea name="rremark[]" class="form-control" requierd></textarea>
                              <?php $i++; }} ?>
                        </div>

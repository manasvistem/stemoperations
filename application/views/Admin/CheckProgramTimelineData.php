...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="card p-3">
    ...
    <hr>
    <?php 
$uniqueAcademicYears = array_unique(array_column($gettimeline, 'academic_year'));
?>
    <div class="row">
      <div class="col-md-9"></div>
      <div class="col-md-3">
      <form action="<?=base_url();?>Menu/CheckProgramTimelineData" method="post" style="align-items: center; display: flex ; padding: 10px;">
       <div class="m-2">

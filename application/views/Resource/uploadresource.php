  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Upload Resource</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
       ...
       <div class="row p-3">
           <div class="col-sm col-md-6 col-lg-6 m-auto">
              ...
              <div class="card-body box-profile">
                  <form action="<?=base_url();?>Menu/addresorce" method="post">
                  ...
                  <div class="form-group">
                    <label>Stage to be shared</label>
                    <input type="text" name="sts" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Title of Creatives</label>
                    <input type="text" name="tof" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Creatives</label>
                    <input type="file" name="creatives" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Video Link</label>
                    <input type="text" name="vlink" class="form-control">
                  </div>
                  <div class="form-group">

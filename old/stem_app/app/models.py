...
class company_contact_master(models.Model):
    ...
    type = models.CharField(verbose_name="Type",default="alternate",null=True,max_length=20)
...
class tblcallevents(models.Model):
    ...
    updation_data_type = models.TextField(verbose_name="Updation Type",default="updated",blank=True,null=True)
